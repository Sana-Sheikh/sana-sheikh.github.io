(function(g) {
    ...
    var C2 = function(a, b) {
        ...
        yFa = function(a, b, c) {
            null != c && (g.pf(a.u, 8 * b + 1), a = a.u, b = c >>> 0, c = Math.floor((c - b) / 4294967296) >>> 0, g.Af = b, g.Bf = c, g.qf(a, g.Af), g.qf(a, g.Bf))
        },
        E2 = function(a, b, c) {
        ...
        zFa = function(a, b) {
            ...
            for (var d = 0, e = 1, f = 0, h = 0; 8 > h; h++) {
                f = g.In(a, c);
                var l = (g.In(a, c + 1E-6) - f) / 1E-6;
                if (1E-6 > Math.abs(f - b)) return c;
                if (1E-6 > Math.abs(l)) break;
                else f < b ? d = c : e = c, c -= (f - b) / l
            }
            for (h = 0; 1E-6 < Math.abs(f - b) && 8 > h; h++) f < b ? (d = c, c = (c + e) / 2) : (e = c, c = (c + d) / 2), f = g.In(a, c);
            return c
        },
        I2 = function(a, b, c) {
            a.u || (a.u = {});
        ...
        J2 = function(a, b, c, d) {
            (c = g.If(a, c)) && c !== b && void 0 !== d && (a.u && c in a.u && (a.u[c] = void 0), g.Mf(a, c, void 0));
            g.Mf(a, b, d)
        },
        K2 = function() {
            return {
        ...
        DFa = function() {
            ...
            this.u = new g.Om(this.flushInterval);
            this.u.ya("tick", this.mH, !1, this)
        },
        EFa = function(a, b) {
        ...
        GFa = function() {
            if (!N2) {
                N2 = new DFa;
                var a = g.Xo("client_streamz_web_flush_count", -1); - 1 !== a && (N2.D = a)
            }
            this.u = N2;
            this.u.WI("/client_streamz/youtube/web/debug/third_party_apisid_cookie_reissue_iframe", {
                zJ: 3,
                yJ: "client_name"
            })
        },
        IFa = function(a) {
            g.Jf(this, a, HFa, null)
        },
        JFa = function(a) {
        ...
        NFa = function(a) {
            g.Jf(this, a, MFa, null)
        },
        PFa = function(a) {
            g.Jf(this, a, null, OFa)
        },
        QFa = function(a) {
            g.Jf(this, a, null, null)
        },
        ...
        T2 = function(a) {
            g.B.call(this);
            this.callback = a;
            this.C = new g.Hn(0, 0, .4, 0, .2, 1, 1, 1);
            this.delay = new g.ln(this.next, window, this);
        ...
        U2 = function(a) {
            ...
            this.previous.ya("click", this.yL, this);
            g.C(this, this.X);
            for (var c = 0; 16 > c; c++) {
                var d = new g.U({
                    G: "a",
                ...
                g.tg(e, "transitionDelay", c / 20 + "s");
                this.N.P(e, "click", g.Ra(this.zL,
                    c));
                this.D.push(d)
            }
            g.C(this, this.next);
            this.next.fa(this.element);
            this.next.ya("click", this.xL, this);
        ...
        ZFa = function(a) {
            for (var b = 0; b < a.u.length; b++) {
                ...
                var e = d.shortViewCount ? d.shortViewCount : d.author,
                    f = d.El();
                g.mD(a.api.S()) && (f = g.Nd(f, g.eP("emb_rel_err")));
                c.element.style.display = "";
                var h = c.ha("ytp-suggestion-title");
                g.Fn.test(d.title) ? h.dir = "rtl" : g.qBa.test(d.title) && (h.dir = "ltr");
                h = c.ha("ytp-suggestion-author");
                g.Fn.test(e) ? h.dir = "rtl" : g.qBa.test(e) && (h.dir = "ltr");
                h = d.isLivePlayback ? "Live" : d.lengthSeconds ? g.DM(d.lengthSeconds) : "";
                c.update({
                    views_or_author: e,
                    duration: h,
                    link: f,
        ...
        $Fa = function(a, b) {
            ...
            c.style.paddingTop = (b.height - a.u.element.clientHeight) / 2 - d / 2 + "px"
        },
        aGa = function(a, b) {
            var c = a.api.S(),
                d;
            b.reason && (X2(b.reason) ? d = g.AG(b.reason) : d = g.GO(g.S(b.reason)), a.Fc(d, "content"));
            var e;
            b.subreason && (X2(b.subreason) ? e = g.AG(b.subreason) : e = g.GO(g.S(b.subreason)), a.Fc(e, "subreason"));
            if (g.P(c.experiments, "embeds_enable_age_gating_playability_check") && b.proceedButton && b.proceedButton.buttonRenderer && (e = b.proceedButton.buttonRenderer, c = a.ha("ytp-error-content-wrap-subreason"), d = g.Ge("A"), e.text && e.text.simpleText)) {
        ...
        Y2 = function(a, b) {
            ...
            this.api.Lb(this.element, this, 96714);
        ...
        Z2 = function(a) {
            ...
            g.C(this, this.u);
            this.u.fa(this.B, 0);
            this.api.Lb(this.element, this, 52428);
        ...
        a3 = function(a, b) {
            ...
            this.I = new g.tM(this, 1E3, !1, 100);
            this.D = [];
            this.u = [];
            this.F = 0;
            this.K = !1;
            ...
            g.C(this, this.previous);
            this.previous.fa(this.element);
            this.previous.ya("click", this.vL, this);
            var e = g.tB || g.wg ? {
            ...
            for (var f = 0; 16 > f; f++) {
                ...
                g.tg(l, "transitionDelay", f / 20 + "s");
                this.B.P(l, "click", g.Ra(this.wL, f));
                this.D.push(h)
            }
            g.C(this, this.next);
            this.next.fa(this.element);
            this.next.ya("click", this.uL, this);
            d = new g.U({
                G: "button",
            ...
            g.C(this, d);
            d.fa(this.element);
            d.ya("click", this.RN, this);
            g.C(this, this.expandButton);
            this.expandButton.fa(this.element);
            this.expandButton.ya("click", this.SN, this);
        ...
        bGa = function(a) {
            for (var b = 0; b < a.u.length; b++) {
                ...
                g.pBa.test(c.title) && (d.ha("ytp-suggestion-title").dir = "rtl");
                g.pBa.test(e) && (d.ha("ytp-suggestion-author").dir = "rtl");
                var f = c.isLivePlayback ? "Live" : c.lengthSeconds ? g.DM(c.lengthSeconds) : "";
                var h = c.El();
                g.mD(a.api.S()) && (h = g.Nd(h, g.eP("emb_rel_pause")));
                d.update({
                    author_and_views: e,
                    duration: f,
                    link: h,
                    title: c.title,
                    aria_label: c.qq || null,
        ...
        c3 = function(a) {
            ...
            g.U.call(this, {
                ...
                T: {
                    target: b.F,
                    href: "{{url}}",
                    "aria-label": g.sK("Watch on $WEBSITE", {
                        WEBSITE: g.KD(b)
                    }),
            ...
            this.B = !1;
            this.state = a.Va();
            a.Lb(this.element, this, 76758);
            this.P(a, "videodatachange", this.WA);
            this.P(a, "videodatachange", this.Pa);
            this.P(a, "presentingplayerstatechange", this.AL);
    ...
    g.k.bR = function(a, b) {
        ...
        this.Ao.set(this.eD(c), [new BFa(a)])
    };
    g.k.UC = function(a) {
        for (var b = [], c = 0; c < arguments.length; ++c) b[c - 0] = arguments[c];
        b = this.eD(b);
        return this.Ao.has(b) ? this.Ao.get(b) : void 0
    };
    g.k.GJ = function(a) {
        for (var b = [], c = 0; c < arguments.length; ++c) b[c - 0] = arguments[c];
        return (b = this.UC(b)) && b.length ? b[0] : void 0
    };
    g.k.clear = function() {
        this.Ao.clear()
    };
    ...
    g.k.WI = function(a, b) {
        for (var c = [], d = 1; d < arguments.length; ++d) c[d - 1] = arguments[d];
        this.B.has(a) || this.B.set(a, new M2(a, c))
    };
    g.k.cL = function(a, b) {
        for (var c = [], d = 1; d < arguments.length; ++d) c[d - 1] = arguments[d];
        this.dL.apply(this, [a, 1].concat(g.ma(c)))
    };
    g.k.dL = function(a, b, c) {
        for (var d = [], e = 2; e < arguments.length; ++e) d[e - 2] = arguments[e];
        (e = EFa(this, a)) && e instanceof M2 && (e.C(b, d), this.u.enabled || this.u.start(), this.C++, this.C >= this.D && this.mH())
    };
    g.k.QG = function(a, b, c) {
    ...
    CFa.prototype.flush = function(a) {
        a = void 0 === a ? [] : a;
        if (g.Wo("enable_client_streamz_web")) {
            ...
            for (var b = a.next(); !b.done; b = a.next()) {
                ...
                var c = new NFa;
                c = g.Mf(c, 1, b.D);
                for (var d = b, e = [], f = 0; f < d.u.length; f++) e.push(d.u[f].yJ);
                c = g.Mf(c, 3, e || []);
                d = [];
                e = [];
                f = g.q(b.Ao.keys());
                ...
                for (f = 0; f < e.length; f++) {
                    h = e[f];
                    var l = b.B;
                    for (var m = b.UC(h) || [], n = [], p = 0; p < m.length; p++) {
                        var r = m[p];
                        r = r && r.eC;
                        var t = new S2;
                        switch (l) {
                            case 3:
                                J2(t, 1, R2[0], Number(r));
                                break;
                            case 2:
                                J2(t, 2, R2[0], Number(r))
                        }
                        n.push(t)
                    }
                    l = n;
                    for (m = 0; m < l.length; m++) {
                        ...
                        r = [];
                        t = b;
                        for (var w = [], x = 0; x < t.u.length; x++) w.push(t.u[x].zJ);
                        t = w;
                        for (w = 0; w < t.length; w++) {
                            ...
                            switch (x) {
                                case 3:
                                    J2(F, 1, P2[0], String(y));
                                    break;
                                case 2:
                                    J2(F, 2, P2[0], Number(y));
                                    break;
                                case 1:
                                    J2(F, 3, P2[0], "true" == y)
                            }
                ...
                if (0 < e.length && null != e)
                    for (f = 0; f < e.length; f++) F2(d, 3, e[f]);
                e = g.Kf(c, 6);
                if (0 < e.length && null != e)
                    for (f = 0; f < e.length; f++) yFa(d, 6, e[f]);
                e = g.Qf(c, O2, 4);
                0 < e.length && H2(d, 4, e, YFa);
                b = g.yf(b);
                b = {
                    serializedIncrementBatch: g.tf(b)
                };
                g.Or("streamzIncremented", b)
            }
        }
    };
    var N2;
    g.u(T2, g.B);
    T2.prototype.start = function(a, b, c) {
        this.u = a;
        this.B = b;
        this.duration = c;
    ...
    g.k.zL = function(a, b) {
        var c = this.u[a],
            d = c.Bd;
        g.AO(b, this.api, this.W, d || void 0) && this.api.Ji(c.Ma().videoId, d, c.getPlaylistId())
    };
    g.k.resize = function(a, b) {
        ...
        if (150 >= Math.min(a.width, a.height) || 0 === h || !c.ob) this.hide();
            ...
            b && r + 100 > b && 50 < m && (r = Math.max(b, 50 / d), m = Math.ceil(l / (d * (r - 100) + this.B)), m = l / m - this.B, r = Math.floor(m /
                d));
    ...
    g.k.Pa = function() {
        ...
        ZFa(this);
        b.F ? this.title.update({
            title: g.sK("More videos from $DNI_RELATED_CHANNEL", {
    ...
    W2.prototype.show = function() {
        ...
        $Fa(this, this.api.Ja().getPlayerSize())
    };
    W2.prototype.resize = function(a) {
        g.FO.prototype.resize.call(this, a);
        $Fa(this, a);
        g.K(this.element, "related-on-error-overlay-visible", !this.u.isHidden())
    };
    W2.prototype.B = function(a) {
        g.FO.prototype.B.call(this, a);
        var b = this.api.getVideoData();
        if (g.P(this.api.S().experiments, "embed_parse_error_renderer_killswitch") || !b.lF && !b.playerErrorMessageRenderer) {
            var c;
            a.dj && (b.wm ? X2(b.wm) ? c = g.AG(b.wm) : c = g.GO(g.S(b.wm)) : c = g.GO(a.dj), this.Fc(c, "subreason"))
        } else(a = b.lF) ? aGa(this, a) : b.playerErrorMessageRenderer && aGa(this, b.playerErrorMessageRenderer)
    };
    g.u(Y2, g.U);
    Y2.prototype.zg = function() {
    ...
    Y2.prototype.u = function() {
        ...
        b = !b.ob;
        var e = this.B.Oe();
        d || e || c || b || !a.videoId ? (this.hide(), this.api.Qa(this.element, !1)) : (a = g.Nd(this.api.getVideoUrl(), g.eP("emb_imp_woyt")), this.za("url", a), this.show())
    };
    Y2.prototype.onClick = function(a) {
        var b = g.Nd(this.api.getVideoUrl(), g.eP("emb_imp_woyt"));
        g.BO(b, this.api, a);
        this.api.vb(this.element)
    };
    Y2.prototype.show = function() {
        this.api.Va().isCued() && (g.U.prototype.show.call(this), this.api.wr(this.element) && this.api.Qa(this.element, !0))
    };
    g.u(Z2, g.U);
    Z2.prototype.C = function() {
        var a = this.api.Va(),
            b = this.api.getVideoData();
        g.P(this.api.S().experiments, "embeds_enable_muted_autoplay") && b.mutedAutoplay && (g.T(a, 2) && !this.bb ? (this.show(), this.u.show(), a = this.api.getVideoData(), this.za("text", a.oB), g.K(this.element, "ytp-muted-autoplay-show-end-panel", !0), this.api.Qa(this.element, this.bb), this.api.va("onMutedAutoplayEnds")) : this.hide())
    };
    ...
    g.u($2, g.U);
    $2.prototype.u = function() {
        var a = this.api.Va(),
            b = this.api.getVideoData();
        g.P(this.api.S().experiments, "embeds_enable_muted_autoplay") && b.mutedAutoplay && !g.T(a, 2) ? this.bb || (g.U.prototype.show.call(this), this.C.start(), this.api.Qa(this.element, this.bb)) : this.hide()
    };
    $2.prototype.B = function() {
        g.K(this.element, "ytp-muted-autoplay-hide-watermark", !0)
    };
    $2.prototype.onClick = function() {
        var a = this.api.getVideoData(),
            b = this.api.getCurrentTime();
        a.mutedAutoplay = !1;
        a.endSeconds = NaN;
    ...
    g.k = a3.prototype;
    g.k.hide = function() {
        g.xn(this.api.getRootNode(), "ytp-expand-pause-overlay");
        g.U.prototype.hide.call(this)
    };
    g.k.RN = function() {
        this.K = !0;
    ...
    g.k.wL = function(a, b) {
        if (1E3 > (0, g.M)() - this.da) g.np(b), document.activeElement.blur();
        else {
            var c = this.u[a],
                d = c.Bd;
            g.AO(b, this.api, this.W, d || void 0) && this.api.Ji(c.Ma().videoId, d, c.getPlaylistId())
    ...
    g.k.Sb = function(a) {
        if (!(g.T(a.state, 1) || g.T(a.state, 16) || g.T(a.state, 32))) {
            var b = !g.P(this.api.S().experiments, "embeds_disable_pauseoverlay_on_autoplay_blocked_killswitch") && g.T(a.state, 2048);
            !g.T(a.state, 4) || g.T(a.state, 2) || b ? this.I.hide() : this.u.length && (this.K || (g.J(this.api.getRootNode(), "ytp-expand-pause-overlay"), b3(this)), this.I.show(), this.da = (0, g.M)())
        }
    };
    g.k.Ra = function(a) {
        var b = 16 / 9,
    ...
    g.k.WA = function() {
        var a = this.api.getVideoData(),
            ...
            c = this.api.S();
        a = (a.mutedAutoplay || c.Bb && !g.T(this.state, 2)) && !(b && c.pfpChazalUi);
        g.OL(this, a);
    ...
    g.k.onClick = function(a) {
        var b = this.api.getVideoUrl(!g.EM(a), !1, !0, !0);
        g.BO(b, this.api, a);
        this.api.vb(this.element)
    };
    g.k.Ra = function(a) {
    ...
    g.k.create = function() {
        var a = this.J.S(),
            b = g.MN(this.J);
        a.ob && (this.F = new a3(this.J, b), g.C(this, this.F), g.WN(this.J, this.F.element, 4));
        g.P(a.experiments, "embeds_enable_muted_autoplay") && (this.u = new $2(this.J), g.C(this, this.u), g.WN(this.J, this.u.element, 4), this.D = new Z2(this.J), g.C(this, this.D), g.WN(this.J, this.D.element, 4));
        if (a.Bb || this.u) this.watermark = new c3(this.J), g.C(this, this.watermark), g.WN(this.J, this.watermark.element, 7);
        g.P(a.experiments, "embeds_impression_link") && (this.C = new Y2(this.J, b),
            g.C(this, this.C), g.WN(this.J, this.C.element, 7));
        ...
        this.B.P(this.J, "onMutedAutoplayStarts", this.JO);
        this.tb(this.J.Va());
        this.player.Yc("embed");
        g.P(a.experiments, "enable_cookie_reissue_iframe") && a.Gf && !g.Cq("__Secure-3PAPISID") && (a = a.deviceParams.c, a = void 0 === a ? "WEB" : a, (new GFa).u.cL("/client_streamz/youtube/web/debug/third_party_apisid_cookie_reissue_iframe", a), a = g.Ge("IFRAME"),
    ...
    g.k.tb = function(a) {
        g.T(a, 128) ? (this.Rd || (this.Rd = new W2(this.J), g.C(this, this.Rd), g.WN(this.J, this.Rd.element, 4)), this.Rd.B(a.getData()), this.Rd.show(), g.J(this.J.getRootNode(), "ytp-embed-error")) : this.Rd && (this.Rd.dispose(), this.Rd = null, g.xn(this.J.getRootNode(), "ytp-embed-error"))
    };
    g.k.JO = function() {
        this.J.getVideoData().mutedAutoplay && this.u && this.watermark && this.watermark.fa(this.u.bottomButtons, 0)
    };
    g.k.PR = function() {
        var a = this.J.getVideoData();
        this.watermark && this.u && !a.mutedAutoplay && g.Pe(this.u.element, this.watermark.element) && g.WN(this.J, this.watermark.element, 7)
    };
    g.nO.embed = d3;
})(_yt_player);