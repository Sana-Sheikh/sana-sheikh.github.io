    ...
    */
    ...
    function za(a) {
        this.next = function(b) {
            qa(a.h);
            a.h.i ? b = wa(a, a.h.i.next, b, a.h.u) : (a.h.u(b), b = ya(a));
            return b
        };
        this["throw"] = function(b) {
            qa(a.h);
            a.h.i ? b = wa(a, a.h.i["throw"], b, a.h.u) : (ra(a.h, b), b = ya(a));
            return b
        };
    ...
    t("Promise", function(a) {
        ...
        b.race = function(g) {
            return new b(function(h, k) {
                for (var l = u(g), n = l.next(); !n.done; n = l.next()) d(n.value).fa(h, k)
            })
        };
        b.all = function(g) {
            var h = u(g),
            ...
            return k.done ? d([]) : new b(function(l, n) {
                ...
                var q = [],
                    r = 0;
                do q.push(void 0), r++, d(k.value).fa(p(q.length - 1), n), k = h.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    t("Map", function(a) {
        ...
        e.prototype.set = function(h, k) {
            ...
            l.D ? l.D.value = k : (l.D = {
                ...
                key: h,
                value: k
            }, l.list.push(l.D), this.h.previous.next = l.D, this.h.previous = l.D, this.size++);
            return this
        };
        e.prototype["delete"] = function(h) {
            h = d(this, h);
            return h.D && h.list ? (h.list.splice(h.index, 1), h.list.length || delete this.i[h.id], h.D.previous.next = h.D.next, h.D.next.previous = h.D.previous, h.D.head = null, this.size--, !0) : !1
        };
    ...
    function Fa(a) {
        if (a && a != x) return Ga(a.document);
        null === Ha && (Ha = Ga(x.document));
        return Ha
    }
    var Ia = /^[\w+/_-]+[=]{0,2}$/,
        Ha = null;
    ...
    function A(a, b) {
        for (var c = a.split("."), d = b || x, e = 0; e < c.length; e++)
    ...
    function Gb(a) {
        if (a instanceof H && a.constructor === H) return a.h;
        La(a);
    ...
    function Kb(a) {
        ...
        a = "object" == typeof a && a.U ? a.T() : String(a);
        Jb.test(a) || (a = "about:invalid#zClosurez");
        return new H(a, Fb)
    }
    var Fb = {},
        Lb = new H("about:invalid#zClosurez", Fb);
    var Mb;
    a: {
        var Nb = x.navigator;
        if (Nb) {
    ...
    function Rb(a, b) {
        ...
        return new Pb(c, b, Qb)
    };

    function Sb(a, b) {
        var c = b instanceof H ? b : Kb(b);
        a.href = Gb(c)
    }
    ...
    function Yb(a) {
        return Xb(a.match(Wb)[3] || null)
    }

    function Zb(a, b, c) {
        if (Array.isArray(b))
            for (var d = 0; d < b.length; d++) Zb(a, String(b[d]), c);
    ...
    var fc = I("Opera"),
        gc = I("Trident") || I("MSIE"),
        hc = I("Edge"),
        ic = I("Gecko") && !(-1 != Mb.toLowerCase().indexOf("webkit") && !I("Edge")) && !(I("Trident") || I("MSIE")) && !I("Edge"),
        jc = -1 != Mb.toLowerCase().indexOf("webkit") && !I("Edge");
    ...
    var uc = sc;
    var vc = I("Firefox") || I("FxiOS"),
        wc = dc() || I("iPod"),
        xc = I("iPad"),
        yc = I("Safari") && !((I("Chrome") || I("CriOS")) && !I("Edge") || I("Coast") || I("Opera") || I("Edge") || I("Edg/") || I("OPR") || I("Firefox") || I("FxiOS") || I("Silk") || I("Android")) && !(dc() || I("iPad") || I("iPod"));
    var zc = {},
        Ac = null;
    ...
    m = Dc.prototype;
    m.clone = function() {
        return new Dc(this.x, this.y)
    };
    m.equals = function(a) {
        return a instanceof Dc && (this == a ? !0 : this && a ? this.x == a.x && this.y == a.y : !1)
    };
    m.ceil = function() {
    ...
    function Ic(a, b, c) {
        var d = arguments,
            ...
            f = String(d[0]),
            g = d[1];
        if (!Cc && g && (g.name || g.type)) {
            f = ["<", f];
            g.name && f.push(' name="', Ub(g.name), '"');
            if (g.type) {
                f.push(' type="', Ub(g.type), '"');
                var h = {};
                pb(h, g);
                delete h.type;
                g = h
    ...
    function Vc(a) {
        if (a !== Uc) throw Error("Bad secret");
    };
    ...
    var $c = null === (Xc = Wc()) || void 0 === Xc ? void 0 : Xc.emptyHTML;
    new Zc(null !== $c && void 0 !== $c ? $c : "", Uc);
    var ad;
    ...
    var dd = null === (ad = Wc()) || void 0 === ad ? void 0 : ad.emptyScript;
    new cd(null !== dd && void 0 !== dd ? dd : "", Uc);
    ...
    new fd("about:blank", Uc);
    new fd("about:invalid#zTSz", Uc);
        ...
        if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
            ...
            if (null ==
                ...
                if (a.constructor && a.constructor instanceof Function) {
                    ...
                    else if (c = a.constructor, ld[c]) c = ld[c];
                    else {
                        c = String(c);
                        if (!ld[c]) {
                            var f = /function\s+([^\(]+)/m.exec(c);
                            ld[c] = f ? f[1] : "[Anonymous]"
                        }
                        c = ld[c]
                    }
    ...
    var od = new nd("undefined" == typeof document ? null : document);
    ...
    function rd() {
            ...
            for (r = 0; 80 > r; r++) {
                if (40 > r)
                    if (20 > r) {
                        var xa = D ^ w & (y ^ D);
                        var oc = 1518500249
                    } else xa = w ^ y ^ D, oc = 1859775393;
                else 60 > r ? (xa = w & y | D & (w | y), oc = 2400959708) : (xa = w ^ y ^ D, oc = 3395469782);
                xa = ((p << 5 | p >>> 27) & 4294967295) + xa + da + oc + q[r] & 4294967295;
                da = D;
                D = y;
        ...
        function c(p, q) {
            if ("string" === typeof p) {
                ...
                for (var r = [], w = 0, y = p.length; w < y; ++w) r.push(p.charCodeAt(w));
                p = r
            }
            q || (q = p.length);
            r = 0;
        ...
        function d() {
            ...
            b(f);
            for (r = q = 0; 5 > r; r++)
                for (var w = 24; 0 <= w; w -= 8) p[q++] = e[r] >> w & 255;
            return p
        }
    ...
    function ud(a) {
        var b = qd(String(x.location.href)),
            c;
        (c = x.__SAPISID || x.__APISID || x.__OVERRIDE_SID) ? c = !0: (c = new nd(document), c = c.get("SAPISID") || c.get("APISID") || c.get("__Secure-3PAPISID") || c.get("SID"), c = !!c);
        if (c && (c = (b = 0 == b.indexOf("https:") || 0 == b.indexOf("chrome-extension:") || 0 == b.indexOf("moz-extension:")) ? x.__SAPISID : x.__APISID, c || (c = new nd(document), c = c.get(b ? "SAPISID" : "APISID") || c.get("__Secure-3PAPISID")), c)) {
            b = b ? "SAPISIDHASH" : "APISIDHASH";
            var d = String(x.location.href);
            return d && c && b ? [b, sd(qd(d),
                c, a || null)].join(" ") : null
        }
        return null
    };
    ...
    vd.prototype.set = function(a, b) {
        b = void 0 === b ? !0 : b;
        0 <= a && 52 > a && 0 === a % 1 && this.i[a] != b && (this.i[a] = b, this.h = -1)
    };
    ...
    function wd(a) {
        -1 == a.h && (a.h = ab(a.i, function(b, c, d) {
    ...
    Md.prototype.update = function(a, b) {
        if (null != a) {
            void 0 === b && (b = a.length);
            for (var c = b - this.i, d = 0, e = this.o, f = this.j; d < b;) {
                if (0 == f)
                    for (; d <= c;) Nd(this, a, d), d += this.i;
                if ("string" === typeof a)
                    for (; d < b;) {
    ...
    function Qd(a, b) {
        ...
        else c = a.classList ? a.classList : Od(a).match(/\S+/g) || [], c = 0 <= Ya(c, b);
        return c
    }

    function Rd() {
        var a = document.body;
        a.classList ? a.classList.remove("inverted-hdpi") : Qd(a, "inverted-hdpi") && Pd(a, Za(a.classList ? a.classList : Od(a).match(/\S+/g) || [], function(b) {
            return "inverted-hdpi" != b
        }).join(" "))
    };
    var Sd = "StopIteration" in x ? x.StopIteration : {
    ...
    function Xd(a, b) {
        ...
        if (1 < c) {
            ...
            if (a instanceof Xd)
                for (c = Yd(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
            else
    ...
    m.clear = function() {
        this.j = {};
        this.N = this.i = this.h.length = 0
    };
    m.remove = function(a) {
        return Object.prototype.hasOwnProperty.call(this.j, a) ? (delete this.j[a], this.i--, this.N++, this.h.length > 2 * this.i && Zd(this), !0) : !1
    };
    ...
    m.set = function(a, b) {
        Object.prototype.hasOwnProperty.call(this.j, a) || (this.i++, this.h.push(a), this.N++);
        this.j[a] = b
    };
    m.forEach = function(a, b) {
        for (var c = Yd(this), d = 0; d < c.length; d++) {
            var e = c[d],
                f = this.get(e);
            a.call(b, f, e, this)
        }
    ...
    var ae = !gc || 9 <= Number(uc),
        be;
    if (be = gc) {
        var ce;
        if (Object.prototype.hasOwnProperty.call(rc, "9")) ce = rc["9"];
        else {
            for (var de = 0, ee = vb(String(qc)).split("."), fe = vb("9").split("."), ge = Math.max(ee.length, fe.length), he = 0; 0 == de && he < ge; he++) {
                var ie = ee[he] || "",
                    je = fe[he] || "";
                do {
                    var ke = /(\d*)(\D*)(.*)/.exec(ie) || ["", "", "", ""],
                        le = /(\d*)(\D*)(.*)/.exec(je) || ["", "", "", ""];
                    if (0 == ke[0].length && 0 == le[0].length) break;
                    de = Eb(0 == ke[1].length ? 0 : parseInt(ke[1], 10), 0 == le[1].length ? 0 : parseInt(le[1], 10)) || Eb(0 == ke[2].length, 0 == le[2].length) || Eb(ke[2], le[2]);
                    ie = ke[3];
                    je = le[3]
                } while (0 == de)
            }
    ...
    var me = be,
        ne = function() {
            ...
            try {
                x.addEventListener("test", Ja, b), x.removeEventListener("test", Ja, b)
            } catch (c) {}
            return a
        }();
    ...
    ve.prototype.add = function(a, b, c, d, e) {
        ...
        var g = we(a, b, d, e); - 1 < g ? (b = a[g], c || (b.ea = !1)) : (b = new te(b, this.src, f, !!d, e), b.ea = c, a.push(b));
        return b
    };
    ...
    function xe(a, b) {
        var c = b.type;
        c in a.listeners && cb(a.listeners[c], b) && (ue(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.h--))
    }

    function we(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.V && f.listener == b && f.capture == !!c && f.ga == d) return e
        }
        return -1
    };
    ...
    function Be(a, b, c, d, e) {
        ...
        else c = De(c), a && a[re] ? Ee(a, b, c, B(d) ? !!d.capture : !!d, e) : Fe(a, b, c, !1, d, e)
    }
    ...
    function Ce(a, b, c, d, e) {
        ...
        else c = De(c), a && a[re] ? a.h.add(String(b), c, !0, B(d) ? !!d.capture : !!d, e) : Fe(a, b, c, !0, d, e)
    }

    function Ke(a, b, c, d, e) {
        if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) Ke(a, b[f], c, d, e);
        else(d = B(d) ? !!d.capture : !!d, c = De(c), a && a[re]) ? a.h.remove(String(b), c, d, e) : a && (a = Ge(a)) && (b = a.listeners[b.toString()], a = -1, b && (a = we(b, c, d, e)), (c = -1 < a ? b[a] : null) && Le(c))
    }
    ...
    function Le(a) {
        if ("number" !== typeof a && a && !a.V) {
            ...
            if (b && b[re]) xe(b.h, a);
                ...
                Ae--;
                (c = Ge(b)) ? (xe(c, a), 0 == c.h && (c.src = null, b[ye] = null)) : ue(a)
            }
        }
    }
        ...
        if (a = Ge(a))
            if (b = a.listeners[b.toString()])
                for (b = b.concat(), a = 0; a < b.length; a++) {
                    var f = b[a];
                    f && f.capture == c && !f.V && (f = Ne(f, d), e = e && !1 !== f)
                }
        return e
    }
    ...
    function Je(a, b) {
        ...
        if (!ae) {
            ...
            if (!(0 > c.keyCode || void 0 != c.returnValue)) {
                ...
                c = [];
                for (f = d.h; f; f = f.parentNode) c.push(f);f = a.type;
                for (var g = c.length - 1; !d.i && 0 <= g; g--) {
                    d.h = c[g];
                    var h = Me(c[g], f, !0, d);
                    e = e && h
                }
                for (g = 0; !d.i && g < c.length; g++) d.h = c[g],
                h = Me(c[g], f, !1, d),
                e = e && h
            }
            return e
        }
        return Ne(a, new pe(b, this))
    }
    ...
    F(Pe, K);
    Pe.prototype[re] = !0;
    Pe.prototype.addEventListener = function(a, b, c, d) {
        Be(this, a, b, c, d)
    };
    Pe.prototype.removeEventListener = function(a, b, c, d) {
        Ke(this, a, b, c, d)
    };
    ...
    function Qe(a, b) {
        ...
        e = b;
        var f = e.type || e;
        if ("string" === typeof e) e = new oe(e, c);
        else if (e instanceof oe) e.target = e.target || c;
        else {
            var g = e;
            e = new oe(f, c);
            pb(e, g)
        ...
        g = !0;
        if (d)
            for (var h = d.length - 1; !e.i && 0 <= h; h--) {
                var k = e.h = d[h];
                g = Re(k, f, !0, e) && g
            }
        e.i || (k = e.h = c, g = Re(k, f, !0, e) && g, e.i || (g = Re(k, f, !1, e) && g));
        if (d)
            for (h = 0; !e.i && h < d.length; h++) k = e.h = d[h], g = Re(k, f, !1, e) && g
    }
        ...
        if (null == b) c.push("null");
            ...
            if ("object" == typeof b) {
                if (Array.isArray(b)) {
                    ...
                    b = d.length;
                    c.push("[");
                    for (var e = "", f = 0; f < b; f++) c.push(e), Te(a, d[f], c), e = ",";
                    c.push("]");
                    return
                }
                if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf();
                    ...
                    c.push("{");
                    e = "";
                    for (d in b) Object.prototype.hasOwnProperty.call(b, d) && (f = b[d], "function" != typeof f && (c.push(e), Ve(d, c), c.push(":"), Te(a, f, c), e = ","));
                    c.push("}");
                    return
                }
            }
        ...
        if (0 == a.h)
            if (a.j) {
                ...
                if (c.i) {
                    ...
                    e && (0 == c.h && 1 == d ? hf(c, b) : (f ? (d = f, d.next == c.l && (c.l = d), d.next = d.next.next) : jf(c), kf(c, e, 3, b)))
                }
                a.j = null
            } else $e(a, 3, b)
    }
    ...
    function ef(a, b, c, d) {
        ...
        e.h = new Ze(function(f, g) {
            ...
            e.onRejected = c ? function(h) {
                try {
                    var k = c.call(d, h);
                    void 0 === k && h instanceof gf ? g(h) : f(k)
                } catch (l) {
                    g(l)
                }
            } : g
    ...
    function $e(a, b, c) {
        if (0 == a.h) {
            ...
            g || (a.u = c, a.h = b, a.j = null, mf(a), 3 != b || c instanceof gf || of (a, c))
        }
    }
    ...
    Ze.prototype.C = function() {
        for (var a; a = jf(this);) kf(this, a, this.h, this.u);
        this.o = !1
    };
    ...
    function kf(a, b, c, d) {
        ...
        if (b.h) b.h.j = null, pf(b, c, d);
        else try {
            b.j ? b.i.call(b.context) : pf(b, c, d)
        } catch (e) {
            qf.call(null, e)
        }
        yd(bf, b)
    ...
    m.clear = function(a) {
        if (a) {
            var b = this.j[a];
            b && (G(b, this.W, this), delete this.j[a])
    ...
    tf.prototype.set = function(a, b) {
        void 0 === b ? this.h.remove(a) : this.h.set(a, Se(b))
    };
    ...
    uf.prototype.set = function(a, b) {
        uf.G.set.call(this, a, wf(b))
    };
    uf.prototype.i = function(a) {
        a = uf.G.get.call(this, a);
    ...
    xf.prototype.set = function(a, b, c) {
        if (b = wf(b)) {
            if (c) {
                if (c < E()) {
                    xf.prototype.remove.call(this, a);
                    return
                }
                b.expiration = c
            }
        ...
        xf.G.set.call(this, a, b)
    };
    xf.prototype.i = function(a) {
        var b = xf.G.i.call(this, a);
        if (b) {
            var c = b.creation,
                d = b.expiration;
            if (d && d < E() || c && c > E()) xf.prototype.remove.call(this, a);
            else return b
        }
    };
    ...
    function Cf(a, b) {
        ...
        if (gc && !(9 <= Number(uc))) {
            Df || (Df = new Xd);
            this.h = Df.get(a);
            this.h || (b ? this.h = document.getElementById(b) : (this.h = document.createElement("userdata"), this.h.addBehavior("#default#userData"), document.body.appendChild(this.h)), Df.set(a, this.h));
            try {
                this.h.load(this.i)
            } catch (c) {
                this.h = null
    ...
    m.set = function(a, b) {
        this.h.setAttribute(Ff(a), b);
        Gf(this)
    };
    m.get = function(a) {
        a = this.h.getAttribute(Ff(a));
        if ("string" !== typeof a && null !== a) throw "Storage mechanism: Invalid value was encountered";
        return a
    };
    m.remove = function(a) {
        this.h.removeAttribute(Ff(a));
        Gf(this)
    };
    m.K = function(a) {
        var b = 0,
    ...
    var Jf = window.yt && window.yt.config_ || window.ytcfg && window.ytcfg.data_ || {};
    ...
    var Qf = window.yt && window.yt.msgs_ || window.ytcfg && window.ytcfg.msgs || {};
    z("yt.msgs_", Qf, void 0);
    ...
    var Uf = 0;
    z("ytDomDomGetNextId", A("ytDomDomGetNextId") || function() {
        return ++Uf
    }, void 0);
    var Vf = {
    ...
    var ib = x.ytEventsEventsListeners || {};
    z("ytEventsEventsListeners", ib, void 0);
    var Yf = x.ytEventsEventsCounter || {
        count: 0
    };
    ...
    function ag(a, b, c, d) {
        ...
        var g = f ? function(h) {
            h = new Wf(h);
            if (!Lc(h.relatedTarget, function(k) {
                    return k == a
    ...
    function eg(a) {
        ...
        this.l = 0;
        this.H = ag(window, "mousemove", C(this.I, this));
        a = C(this.F, this);
        "function" === typeof a && (a = Nf(a));
        this.J = window.setInterval(a, 25)
    }
    F(eg, K);
    ...
    function hg(a, b, c) {
        ...
        return d ? d(a, b, c) : void 0 === c ? (a(), NaN) : P(a, c || 0)
    }
    ...
    function lg(a) {
        var b = void 0 === a ? {} : a;
        a = void 0 === b.Ma ? !0 : b.Ma;
        b = void 0 === b.cb ? !1 : b.cb;
        if (null == A("_lact", window)) {
            var c = parseInt(N("LACT"), 10);
            c = isFinite(c) ? E() - Math.max(c, 0) : -1;
            z("_lact", c, window);
            z("_fact", c, window); - 1 == c && mg();
            ag(document, "keydown", mg);
            ag(document, "keyup", mg);
            ag(document, "mousedown", mg);
            ag(document, "mouseup", mg);
            a && (b ? ag(window, "touchmove", function() {
                ng("touchmove", 200)
            }, {
                passive: !0
            }) : (ag(window, "resize", function() {
                ng("resize", 200)
            }), ag(window, "scroll", function() {
                ng("scroll", 200)
            })));
            new eg(function() {
                ng("mouse", 100)
            });
            ag(document, "touchstart", mg, {
                passive: !0
            });
            ag(document, "touchend", mg, {
                passive: !0
            })
        }
    }
    ...
    function mg() {
        null == A("_lact", window) && lg();
        var a = E();
        z("_lact", a, window); - 1 == A("_fact", window) && z("_fact", a, window);
    ...
    var pg = x.ytPubsubPubsubInstance || new L,
        qg = x.ytPubsubPubsubSubscribedKeys || {},
        rg = x.ytPubsubPubsubTopicToKeys || {},
        sg = x.ytPubsubPubsubIsSynchronous || {};
    ...
    function tg(a, b) {
        ...
        if (c && b) {
            var d = c.subscribe(a, function() {
                var e = arguments;
                var f = function() {
                    qg[d] && b.apply && "function" == typeof b.apply && b.apply(window, e)
                };
                try {
                    sg[a] ? f() : P(f, 0)
                } catch (g) {
    ...
    function xg(a) {
        ...
        if (b)
            if (b.clear(a), a) yg(a);
                ...
                for (var c in rg) yg(c)
    }

    function ug() {
        return x.ytPubsubPubsubInstance
    }

    function yg(a) {
        rg[a] && (a = rg[a], G(a, function(b) {
            qg[b] && delete qg[b]
        }), a.length = 0)
    }
    L.prototype.subscribe = L.prototype.subscribe;
    L.prototype.unsubscribeByKey = L.prototype.W;
    L.prototype.publish = L.prototype.O;
    L.prototype.clear = L.prototype.clear;
    z("ytPubsubPubsubInstance", pg, void 0);
    z("ytPubsubPubsubTopicToKeys", rg, void 0);
    z("ytPubsubPubsubIsSynchronous", sg, void 0);
    z("ytPubsubPubsubSubscribedKeys", qg, void 0);
    var zg = window,
        Q = zg.ytcsi && zg.ytcsi.now ? zg.ytcsi.now : zg.performance && zg.performance.timing && zg.performance.now && zg.performance.timing.navigationStart ? function() {
            return zg.performance.timing.navigationStart + zg.performance.now()
        } : function() {
            return (new Date).getTime()
        };
    var Ag = Tf("initial_gel_batch_timeout", 1E3),
        Bg = Math.pow(2, 16) - 1,
        Cg = null,
        Dg = 0,
        Eg = void 0,
        ...
        Hg = 0,
        Ig = !0,
        Jg = x.ytLoggingTransportGELQueue_ || new Map;
    z("ytLoggingTransportGELQueue_", Jg, void 0);
    var Kg = x.ytLoggingTransportTokensToCttTargetIds_ || {};
    ...
    function Lg(a) {
        ...
        return new Ze(function(b) {
            ...
            dg(Gg);
            Gg = 0;
            Eg && Eg.isReady() ? (Mg(b, a), Jg.clear()) : (Ng(), b())
        })
    }

    function Ng() {
        O("web_gel_timeout_cap") && !Gg && (Gg = P(Lg, 6E4));
        dg(Fg);
        var a = N("LOGGING_BATCH_TIMEOUT", Tf("web_gel_debounce_ms", 1E4));
        O("shorten_initial_gel_batch_timeout") && Ig && (a = Ag);
        Fg = P(Lg, a)
    }
    ...
    function Mg(a, b) {
        var c = Eg;
        b = void 0 === b ? !1 : b;
        for (var d = Math.round(Q()), e = Jg.size, f = u(Jg), g = f.next(); !g.done; g = f.next()) {
            var h = u(g.value);
            g = h.next().value;
            var k = h.next().value;
            h = nb({
    ...
    function Rg(a, b) {
        ...
        var c = N("EVENT_ID", void 0);
        if (c) {
            var d = N("BATCH_CLIENT_COUNTER", void 0) || 0;
            !d && O("web_client_counter_random_seed") && (d = Math.floor(Math.random() * Bg / 2));
            d++;
            d > Bg && (d = 1);
            M("BATCH_CLIENT_COUNTER", d);
            c = {
                serializedEventId: c,
                clientCounter: String(d)
            };
            a.serializedClientEventId = c;
            Cg && Dg && O("log_gel_rtt_web") && (a.previousBatchInfo = {
                serializedClientEventId: Cg,
                roundtripMs: String(Dg)
            });
            Cg = c;
            Dg = 0
        }
    ...
    var Tg = x.ytLoggingGelSequenceIdObj_ || {};
    z("ytLoggingGelSequenceIdObj_", Tg, void 0);

    function Ug(a, b, c, d) {
        d = void 0 === d ? {} : d;
        var e = {};
        e.eventTimeMs = Math.round(d.timestamp || Q());
        e[a] = b;
        a = og();
        e.context = {
            lastActivityMs: String(d.timestamp || !isFinite(a) ? -1 : a)
        };
        O("log_sequence_info_on_gel_web") && d.M && (a = e.context, b = d.M, Tg[b] = b in Tg ? Tg[b] + 1 : 0, a.sequence = {
            index: Tg[b],
            groupKey: b
        }, d.Ha && delete Tg[d.M]);
        d = d.L;
        a = "";
        d && (a = {}, d.videoId ? a.videoId = d.videoId : d.playlistId && (a.playlistId = d.playlistId), Kg[d.token] = a, a = d.token);
        d = Jg.get(a) || [];
        Jg.set(a, d);
        d.push(e);
        c && (Eg = new c);
        c = Tf("web_logging_max_batch") ||
            100;
        e = Q();
        d.length >= c ? Lg(!0) : 10 <= e - Hg && (Ng(), Hg = e)
    };

    function Vg() {
        var a = Wg;
        A("yt.ads.biscotti.getId_") || z("yt.ads.biscotti.getId_", a, void 0)
    }
        ...
        for (var c = a.split(b), d = {}, e = 0, f = c.length; e < f; e++) {
            ...
            if (1 == g.length && g[0] || 2 == g.length) try {
                ...
                l.args = [{
                    ...
                    value: g[1],
                    query: a,
                    method: bh == p ? "unchanged" : p
                }];
                Zg.hasOwnProperty(n) || ("ReferenceError" === l.name ? Pf(l) : Of(l))
            }
        }
        return d
    }
    ...
    function ah(a) {
        return a && a.match(Yg) ? a : decodeURIComponent(a.replace(/\+/g, " "))
    };
    ...
    function fh(a) {
        ...
        J.screen && (e.u_h = J.screen.height, e.u_w = J.screen.width,
            e.u_ah = J.screen.availHeight, e.u_aw = J.screen.availWidth, e.u_cd = J.screen.colorDepth);
        ...
        l = b.h.top;
        try {
            var w = (l || window).document,
                y = "CSS1Compat" == w.compatMode ? w.documentElement : w.body;
            var D = (new Ec(y.clientWidth, y.clientHeight)).round()
        } catch (da) {
            D = new Ec(-12245933, -12245933)
        }
        w = D;
        D = {};
        y = new vd;
        x.SVGElement && x.document.createElementNS && y.set(0);
        l = Qc();
        l["allow-top-navigation-by-user-activation"] && y.set(1);
        l["allow-popups-to-escape-sandbox"] && y.set(2);
        x.crypto && x.crypto.subtle && y.set(3);
        x.TextDecoder && x.TextEncoder && y.set(4);
        y = wd(y);
        D.bc = y;
        D.bih = w.height;
        D.biw = w.width;
        ...
        b = (D.vis = {
            ...
            preview: 4,
            unloaded: 5
        }[b.visibilityState || b.webkitVisibilityState || b.mozVisibilityState || ""] || 0, D.wgl = !!J.WebGLRenderingContext, D);
        c = d.call(c, e, b);
        c.ca_type = "image";
        a && (c.bid = a);
        return c
    ...
    var hh = "XMLHttpRequest" in x ? function() {
    ...
    var kh = {
        ...
        lh = "app debugcss debugjs expflag force_ad_params force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address client_dev_root_url".split(" "),
        mh = !1;

    function nh(a, b) {
        b = void 0 === b ? {} : b;
        if (!c) var c = window.location.href;
        var d = a.match(Wb)[1] || null,
            e = Yb(a);
        d && e ? (d = c, c = a.match(Wb), d = d.match(Wb), c = c[3] == d[3] && c[1] == d[1] && c[4] == d[4]) : c = e ? Yb(c) == e && (Number(c.match(Wb)[4] || null) || null) == (Number(a.match(Wb)[4] || null) || null) : !0;
        d = O("web_ajax_ignore_global_headers_if_set");
        for (var f in kh) e = N(kh[f]), !e || !c && Yb(a) || d && void 0 !== b[f] || (b[f] = e);
        if (c || !Yb(a)) b["X-YouTube-Utc-Offset"] = String(-(new Date).getTimezoneOffset());
        (c || !Yb(a)) && (f = "undefined" != typeof Intl ?
            (new Intl.DateTimeFormat).resolvedOptions().timeZone : null) && (b["X-YouTube-Time-Zone"] = f);
        if (c || !Yb(a)) b["X-YouTube-Ad-Signals"] = ch(fh(void 0));
        return b
    }
    ...
    function ph(a, b) {
        if (window.fetch && "XML" != b.format) {
                ...
                if (!e) {
                    ...
                    var h = g.ok,
                        k = function(l) {
                            ...
                            b.onFinish && b.onFinish.call(n, l, g)
                        };
            ...
            b.onFetchTimeout && 0 < b.timeout && (f = P(function() {
                e || (e = !0, dg(f), b.onFetchTimeout.call(b.context || x))
            }, b.timeout))
        } else sh(a, b)
    }
    ...
    function sh(a, b) {
        ...
        var d = rh(a, b),
            ...
            f = th(a, function(k) {
                    if (!e) {
                        ...
                        if (l || p || q) n = uh(a, c, k, b.convertToSafeHtml);
        ...
        if (b.onTimeout && 0 < b.timeout) {
            var g = b.onTimeout;
            var h = P(function() {
                e || (e = !0, f.abort(), dg(h), g.call(b.context || x, f))
            }, b.timeout)
        }
        return f
    }
    ...
    function rh(a, b) {
        ...
        b.excludeXsrf || Yb(a) && !b.withCredentials && Yb(a) != document.location.hostname || "POST" != b.method || h && "application/x-www-form-urlencoded" != h || b.postParams && b.postParams[g] || (f || (f = {}), f[c] = d);
        f && "string" === typeof e && (e = dh(e), pb(e, f), e = b.postBodyFormat && "JSON" == b.postBodyFormat ? JSON.stringify(e) : $b(e));
        f = e || f && !jb(f);
        !mh && f &&
            "POST" != b.method && (mh = !0, Of(Error("AJAX request with postData should use POST")));
        return e
    }
        ...
        switch (b) {
            case "JSON":
                try {
                    ...
                    throw d = Error("Error reading responseText"), d.params = a, Pf(d), g;
                }
                a = c.getResponseHeader("Content-Type") || "";
                f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f));
                break;
            case "XML":
                if (a = (a = c.responseXML) ? vh(a) : null) e = {}, G(a.getElementsByTagName("*"), function(g) {
                    e[g.tagName] = wh(g)
                })
        }
        d && xh(e);
    ...
    function th(a, b, c, d, e, f, g) {
        function h() {
            4 == (k && "readyState" in k ? k.readyState : 0) && b && Nf(b)(k)
        }
        c = void 0 === c ? "GET" : c;
        d = void 0 === d ? "" : d;
        var k = ih();
        ...
        O("debug_forward_web_query_parameters") && (a = oh(a));
        k.open(c, a, !0);
        f && (k.responseType = f);
    ...
    function Pg() {
        return {
            ...
            Na: N("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
            Oa: N("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
            innertubeContextClientVersion: N("INNERTUBE_CONTEXT_CLIENT_VERSION", void 0),
            Qa: N("INNERTUBE_CONTEXT_HL", void 0),
            Pa: N("INNERTUBE_CONTEXT_GL", void 0),
            Ra: N("INNERTUBE_HOST_OVERRIDE", void 0) || "",
            Ta: !!N("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
            Sa: !!N("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
    ...
    function Og(a) {
        ...
        a.appInstallData && O("web_log_app_install_experiments") && (b.client.configInfo = b.client.configInfo || {}, b.client.configInfo.appInstallData = a.appInstallData);
        ...
        e = b.client;
        c = {};
        d = u(Object.entries(dh(N("DEVICE", ""))));
        for (var g = d.next(); !g.done; g = d.next()) {
            var h = u(g.value);
            g = h.next().value;
            h = h.next().value;
            "cbrand" === g ? c.deviceMake = h : "cmodel" === g ? c.deviceModel = h : "cbr" === g ? c.browserName =
                h : "cbrver" === g ? c.browserVersion = h : "cos" === g ? c.osName = h : "cosver" === g ? c.osVersion = h : "cplatform" === g && (c.platform = h)
        }
    ...
    function zh(a, b, c) {
        ...
        (b = c.sk || N("AUTHORIZATION")) || (a ? b = "Bearer " + A("gapi.auth.getToken")().rk : b = ud([]));
    ...
    function Ch(a) {
        var b = new Bf;
        (b = b.isAvailable() ? a ? new Hf(b, a) : b : null) || (a = new Cf(a || "UserDataSharedStore"), b = a.isAvailable() ? a : null);
        this.h = (a = b) ? new xf(a) : null;
    ...
    Ch.prototype.get = function(a, b) {
        ...
        if (d && (c = od.get("" + a, void 0)) && (c = unescape(c), b)) try {
            c = JSON.parse(c)
        } catch (e) {
    ...
    Ch.prototype.remove = function(a) {
        ...
        var b = this.i;
        od.remove("" + a, "/", void 0 === b ? "youtube.com" : b)
    };
    var Dh;

    function Eh() {
        Dh || (Dh = new Ch("yt.innertube"));
        return Dh
    }
    ...
    function Fh(a, b, c, d) {
        ...
        Eh().set("nextId", d + 1, 86400, !0);
        Eh().set("requests", e, 86400, !0);
        return d
    }

    function Gh(a) {
        var b = Eh().get("requests", !0) || {};
        delete b[a];
        Eh().set("requests", b, 86400, !0)
    }
        ...
        if (b) {
            for (var c in b) {
                ...
                if (!(6E4 > Math.round(Q()) - d.requestTime)) {
                    var e = d.authState,
                        f = Ah(zh(!1));
                    lb(e, f) && (e = d.request, "requestTimeMs" in e && (e.requestTimeMs = Math.round(Q())), Sg(a, d.method, e, {}));
                    delete b[c]
                }
            }
            Eh().set("requests", b, 86400, !0)
    ...
    var Kh = A("ytPubsub2Pubsub2Instance") || new L;
    L.prototype.subscribe = L.prototype.subscribe;
    L.prototype.unsubscribeByKey = L.prototype.W;
    L.prototype.publish = L.prototype.O;
    L.prototype.clear = L.prototype.clear;
    z("ytPubsub2Pubsub2Instance", Kh, void 0);
    var Lh = A("ytPubsub2Pubsub2SubscribedKeys") || {};
    z("ytPubsub2Pubsub2SubscribedKeys", Lh, void 0);
    var Mh = A("ytPubsub2Pubsub2TopicToKeys") || {};
    z("ytPubsub2Pubsub2TopicToKeys", Mh, void 0);
    var Nh = A("ytPubsub2Pubsub2IsAsync") || {};
    z("ytPubsub2Pubsub2IsAsync", Nh, void 0);
    ...
    function Qh(a) {
        ...
        var d = c.subscribe(b.toString(), function(e, f) {
            ...
            }, Nh[b.toString()] ? A("yt.scheduler.instance") ? gg(g) : P(g, 0) : g())
        });
        Lh[d] = !0;
        Mh[b.toString()] || (Mh[b.toString()] = []);
        Mh[b.toString()].push(d);
        return d
    }
    ...
    v(R, Error);
    var $h = {},
        ai = ($h.AUTH_INVALID = "No user identifier specified.", $h.EXPLICIT_ABORT = "Transaction was explicitly aborted.", $h.IDB_NOT_SUPPORTED = "IndexedDB is not supported.", $h.MISSING_OBJECT_STORE = "Object store not created.", $h.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons.", $h.QUOTA_EXCEEDED = "The current transaction exceeded its quota limitations.", $h.QUOTA_MAYBE_EXCEEDED = "The current transaction may have failed because of exceeding quota limitations.", $h.EXECUTE_TRANSACTION_ON_CLOSED_DB =
            "Can't start a transaction on a closed database", $h);
    ...
    function bi(a) {
        S.call(this, "MISSING_OBJECT_STORE", {
            xk: a
        }, ai.MISSING_OBJECT_STORE);
        Object.setPrototypeOf(this, bi.prototype)
    }
    v(bi, S);
    var ci = ["The database connection is closing", "Can't start a transaction on a closed database", "A mutation operation was attempted on a database that did not allow mutations"];

    function di(a, b, c) {
        if (a instanceof S || a instanceof R) return a;
        if ("QuotaExceededError" === a.name) return new S("QUOTA_EXCEEDED", {
            objectStoreNames: c,
            dbName: b
        });
        if (yc && "UnknownError" === a.name) return new S("QUOTA_MAYBE_EXCEEDED", {
            objectStoreNames: c,
            dbName: b
        });
        if ("InvalidStateError" === a.name && ci.some(function(d) {
                return a.message.includes(d)
            })) return new S("EXECUTE_TRANSACTION_ON_CLOSED_DB", {
            objectStoreNames: c,
            dbName: b
        });
    ...
    function T(a) {
        ...
        this.i(function(c) {
            if ("PENDING" === b.state.status) {
                ...
                c = u(b.h);
                for (var d = c.next(); !d.done; d = c.next()) d = d.value, d()
            }
        }, function(c) {
            if ("PENDING" === b.state.status) {
                b.state = {
    ...
    T.all = function(a) {
        return new T(function(b, c) {
            ...
            for (var f = {
                    ...
                    P: f.P
                }, ++f.P) gi(T.resolve(a[f.P]).then(function(g) {
                return function(h) {
                    d[g.P] = h;
                    e--;
                    0 === e && b(d)
    ...
    T.prototype.then = function(a, b) {
        var c = this,
            d = null !== a && void 0 !== a ? a : fi,
            e = null !== b && void 0 !== b ? b : ei;
        return new T(function(f, g) {
            "PENDING" === c.state.status ? (c.h.push(function() {
                hi(c, c, d, f, g)
            }), c.onRejected.push(function() {
                ii(c, c, e, f, g)
            })) : "FULFILLED" === c.state.status ? hi(c, c, d, f, g) : "REJECTED" === c.state.status && ii(c, c, e, f, g)
        })
    };
    ...
    function hi(a, b, c, d, e) {
        try {
            ...
            f instanceof T ? ji(a, b, f, d, e) : d(f)
        } catch (g) {
            e(g)
        }
    }
    ...
    m.add = function(a, b, c) {
        return oi(this, [a], "readwrite", function(d) {
            return pi(d, a).add(b, c)
        })
    };
    m.clear = function(a) {
        return oi(this, [a], "readwrite", function(b) {
            return pi(b, a).clear()
        })
    };
    m.close = function() {
    ...
    m.count = function(a, b) {
        return oi(this, [a], "readonly", function(c) {
            return pi(c, a).count(b)
        })
    };
    m["delete"] = function(a, b) {
        return oi(this, [a], "readwrite", function(c) {
            return pi(c, a)["delete"](b)
        })
    };
    m.get = function(a, b) {
        return oi(this, [a], "readwrite", function(c) {
    ...
    function oi(a, b, c, d) {
        ...
        try {
            ...
            var f = qi(e, d)["catch"](function(g) {
                throw di(g, a.h.name, b.join());
            })
        } catch (g) {
            f = g instanceof Error ? Promise.reject(di(g, a.h.name, b.join())) : Promise.reject(di(Error("unexpected transaction error: " + g), a.h.name, b.join()))
        }
        ri(a, f, b.join(), c);
        return f
    }
    ...
    function ri(a, b, c, d) {
        cc(a, function f() {
            ...
            return Aa(f, function(q) {
                if (1 == q.h) return g = Math.round(Q()), q.l = 2, sa(q, b, 4);
                2 != q.h ? (h = Math.round(Q()), si(k, !0, c, h - g), q.h = 0, q.l = 0) : (l = ta(q), n = Math.round(Q()), p = n - g, l instanceof S && ("QUOTA_EXCEEDED" === l.type || "QUOTA_MAYBE_EXCEEDED" === l.type) && Zh("QUOTA_EXCEEDED", {
                    dbName: k.h.name,
                    objectStoreNames: c,
                    transactionCount: k.transactionCount,
                    transactionMode: d
                }), l instanceof S && "UNKNOWN_ABORT" === l.type && (Zh("TRANSACTION_UNEXPECTEDLY_ABORTED", {
                    objectStoreNames: c,
                    transactionDuration: p,
                    transactionCount: k.transactionCount,
                    dbDuration: n - k.j
                }), k.i = !0), si(k, !1, c, p), q.h = 0)
            })
        })
    }

    function si(a, b, c, d) {
        Zh("TRANSACTION_ENDED", {
            objectStoreNames: c,
    ...
    m.clear = function() {
        return U(this.h.clear()).then(function() {})
    };
    m.count = function(a) {
    ...
    m["delete"] = function(a) {
        return a instanceof IDBKeyRange ? ui(this, a) : U(this.h["delete"](a))
    };
    m.get = function(a) {
        return U(this.h.get(a))
    };
    m.index = function(a) {
        return new wi(this.h.index(a))
    };
    m.getName = function() {
        return this.h.name
    };
    ...
    wi.prototype.count = function(a) {
        return U(this.h.count(a))
    };
    wi.prototype["delete"] = function(a) {
        return Ai(this, {
            query: a
        }, function(b) {
    ...
    wi.prototype.getKey = function(a) {
    ...
    function xi(a) {
        return U(a).then(function(b) {
            return null === b ? null : new Bi(a, b)
        })
    }
    m = Bi.prototype;
    m.advance = function(a) {
        this.cursor.advance(a);
        return xi(this.request)
    };
    ...
    m["delete"] = function() {
        return U(this.cursor["delete"]()).then(function() {})
    };
    m.getKey = function() {
    ...
    function Ci(a, b, c) {
        return cc(this, function e() {
            var f, g, h, k, l, n, p, q, r, w;
            return Aa(e, function(y) {
                if (1 == y.h) return f = self.indexedDB.open(a, b), g = c, h = g.blocked, k = g.blocking, l = g.ob, n = g.upgrade, p = g.closed, r = function() {
                    q || (q = new ni(f.result, {
                        closed: p
                    }));
                    return q
                    ...
                    D.dataLoss && "none" !== D.dataLoss && Zh("IDB_DATA_CORRUPTED", {
                        reason: D.dataLossMessage || "unknown reason",
                        dbName: a
                    });
                    var da = r(),
                        xa = new yi(f.transaction);
                    n && n(da, D.oldVersion, D.newVersion, xa)
                }), h && f.addEventListener("blocked", function() {
                    h()
                }), sa(y, li(f), 2);
                w = y.m;
                k && w.addEventListener("versionchange", function() {
                    k(r())
                });
                w.addEventListener("close", function() {
                    Zh("IDB_UNEXPECTEDLY_CLOSED", {
                        dbName: a,
                        dbVersion: w.version
                    });
                    l && l()
    ...
    Ei.prototype["delete"] = function(a) {
        a = void 0 === a ? {} : a;
        return Di(this.name, a)
    };
    ...
    function Gi() {
        ...
        if (!a.h) {
            var b = function() {
                ...
                d = function() {
                    return cc(a, function g() {
                        var h = this,
                            k, l, n;
                        return Aa(g, function(p) {
                            switch (p.h) {
                                case 1:
                                    return p.l = 2, sa(p, Fi(h.name, h.options.version, c), 4);
                                case 4:
                                    k = p.m;
                                    if (!vc) {
                                        p.h = 5;
                                    ...
                                    a: {
                                        var q = u(Object.keys(h.options.Xa));
                                ...
                                case 2:
                                    n = ta(p);
                                    if (n instanceof DOMException ? "VersionError" === n.name : "DOMError" in self && n instanceof DOMError ? "VersionError" === n.name : n instanceof Object && "message" in n && "An attempt was made to open a database using a lower version than the existing version." === n.message) return p["return"](Fi(h.name, void 0, Object.assign(Object.assign({}, c), {
                                        upgrade: void 0
                                    })));
                                    b();
                                    throw n;
    ...
    function Ii(a) {
        return cc(this, function c() {
            ...
            return Aa(c, function(e) {
                if (1 == e.h) return sa(e, Gi(), 2);
                d = e.m;
                return e["return"](oi(d, ["databases"], "readwrite", function(f) {
                    var g = pi(f, "databases");
                    return g.get(a.actualName).then(function(h) {
                        if (h ? a.actualName !== h.actualName || a.publicName !== h.publicName || a.userIdentifier !== h.userIdentifier || a.signedIn !== h.signedIn || a.clearDataOnAuthChange !== h.clearDataOnAuthChange : 1) return U(g.h.put(a, void 0)).then(function() {})
                    })
                }))
            })
        })
        ...
        return cc(this, function b() {
            ...
            return Aa(b, function(e) {
                switch (e.h) {
                    case 1:
                        var f;
                        if (f = Vh) f = /WebKit\/([0-9]+)/.exec(Mb), f = !!(f && 600 <= parseInt(f[1], 10));
                        f && (f = /WebKit\/([0-9]+)/.exec(Mb), f = !(f && 602 <= parseInt(f[1], 10)));
                        if (f && !O("ytidb_allow_on_ios_safari_v8_and_v9") || hc) return e["return"](!1);
                        try {
    ...
    function Si(a) {
        window.addEventListener("online", function() {
            a.l = !0;
            a.j && Qe(a, "ytnetworkstatus-online");
            Ti(a);
            if (a.o && O("offline_error_handling")) {
                var b = Oi().get("errors", !0);
                if (b) {
                    for (var c in b)
                        if (b[c]) {
    ...
    function Ri(a) {
        window.addEventListener("offline", function() {
            a.l = !1;
            a.j && Qe(a, "ytnetworkstatus-offline");
            Ti(a)
        })
    }

    function Ti(a) {
        a.u && (Pf(new R("NetworkStatusManager state did not match poll", Q() - 0)), a.u = !1)
    };
    ...
    function Ui(a) {
        ...
        this.j.j = !0;
        a.Va && (this.j.o = !0);
        a.ha ? (this.ha = a.ha, Ee(this.j, "ytnetworkstatus-online", function() {
            Vi(b, "publicytnetworkstatus-online")
        }), Ee(this.j, "ytnetworkstatus-offline", function() {
            Vi(b, "publicytnetworkstatus-offline")
        })) : (Ee(this.j, "ytnetworkstatus-online", function() {
            Qe(b, "publicytnetworkstatus-online")
        }), Ee(this.j, "ytnetworkstatus-offline", function() {
            Qe(b, "publicytnetworkstatus-offline")
        }))
    }
    v(Ui, Pe);

    function Vi(a, b) {
        a.ha ? a.l ? (jg(a.u), a.u = gg(function() {
            a.o !== b && (Qe(a, b), a.o = b, a.l = Q())
        }, a.ha - (Q() - a.l))) : (Qe(a, b), a.o = b, a.l = Q()) : Qe(a, b)
    };
    var Wi;
    ...
    function Xi(a, b) {
        ...
        Mi().then(function() {
            ...
            Wi.j.l !== Qi() && Pf(new R("NetworkStatusManager isOnline does not match window status"));
            sh(a, b)
        })
    }
    ...
    function Zi(a) {
        var b = this;
        this.h = null;
        a ? this.h = a : yh() && (this.h = Pg());
        hg(function() {
            Hh(b)
        }, 0, 5E3)
    }
    Zi.prototype.isReady = function() {
        !this.h && yh() && (this.h = Pg());
        return !!this.h
    };

    function Sg(a, b, c, d) {
        !N("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && Pf(new R("Missing VISITOR_DATA when sending innertube request.", b, c, d));
        if (!a.isReady()) {
            var e = new R("innertube xhrclient not ready", b, c, d);
            Of(e);
            throw e;
        }
        var f = {
        ...
        a.h.Sa && f.headers.Authorization || (l.key = a.h.innertubeApiKey);
        var n = eh("" + g + e, l || {}, !0);
        Mi().then(function(p) {
            if (d.retry && O("retry_web_logging_batches") && "www.youtube-nocookie.com" != g) {
                if (O("networkless_gel") && !p || !O("networkless_gel")) var q = Fh(b,
                    c, k, h);
                if (q) {
                    var r = f.onSuccess,
                        w = f.onFetchSuccess;
                    f.onSuccess = function(y, D) {
                        Gh(q);
                        r(y, D)
                    };
                    c.onFetchSuccess = function(y, D) {
                        Gh(q);
                        w(y, D)
                    }
                }
            ...
            try {
                O("use_fetch_for_op_xhr") ? ph(n, f) : O("networkless_gel") && d.retry ? (f.method = "POST", !d.pb && O("nwl_send_fast_on_unload") ? Yi(n, f) : Xi(n, f)) : (f.method = "POST", f.postParams || (f.postParams = {}), sh(n, f))
            } catch (y) {
                if ("InvalidAccessError" == y.name) q && (Gh(q), q = 0), Pf(Error("An extension is blocking network request."));
                else throw y;
            }
            q && hg(function() {
                Hh(a)
    ...
    function V(a, b, c) {
        c = void 0 === c ? {} : c;
        var d = Zi;
        N("ytLoggingEventsDefaultDisabled", !1) && Zi == Zi && (d = null);
        Ug(a, b, d, c)
    };
    var $i = [{
        ya: function(a) {
    ...
    var ij = new Set,
        ...
        kj = 0,
        lj = 0,
        mj = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];
    ...
    function oj(a, b, c, d, e, f) {
        f = void 0 === f ? {} : f;
        f.name = c || N("INNERTUBE_CONTEXT_CLIENT_NAME", 1);
        f.version = d || N("INNERTUBE_CONTEXT_CLIENT_VERSION", void 0);
        c = f || {};
        b = void 0 === b ? "ERROR" : b;
        b = void 0 === b ? "ERROR" : b;
        if (a && (O("console_log_js_exceptions") && (d = [], d.push("Name: " + a.name), d.push("Message: " + a.message), a.hasOwnProperty("params") && d.push("Error Params: " + JSON.stringify(a.params)), d.push("File name: " + a.fileName), d.push("Stacktrace: " + a.stack), window.console.log(d.join("\n"), a)), !(5 <= jj))) {
            var g = jd(a);
                ...
                for (var k = 0, l = 0; l < a.args.length; l++) {
                    ...
                    if (n)
                        if (Array.isArray(n)) {
                            var q = c,
                                r = k;
                            for (k = 0; k < n.length && !(n[k] && (r += gj(k, n[k], p, q), 500 < r)); k++);
                            k = r
                        } else if ("object" === typeof n)
                        for (q in q = void 0, r = c,
                            n) {
                            if (n[q]) {
                                var w = q;
                                var y = n[q],
                                    D = r;
                                w = "string" !== typeof y || "clickTrackingParams" !== w && "trackingParams" !== w ? 0 : (y = ej(atob(y.replace(/-/g, "+").replace(/_/g, "/")))) ? gj(w + ".ve", y, p, D) : 0;
                                k += w;
                                k += gj(q, n[q], p, r);
                                if (500 < k) break
                            }
                        } else c[p] = hj(n), k += c[p].length;
                    else c[p] = hj(n), k += c[p].length;
                    if (500 <= k) break
                } else if (a.hasOwnProperty("params") && a.params)
                    if (n = a.params, "object" === typeof a.params)
                        for (l in p = 0, n) {
                            if (n[l] && (q = "params." + l, r = hj(n[l]), c[q] = r, p += q.length + r.length, 500 < p)) break
                        } else c.params = hj(n);
            navigator.vendor &&
                !c.hasOwnProperty("vendor") && (c["device.vendor"] = navigator.vendor);
            c = {
                message: d,
                name: e,
                lineNumber: f,
            ...
            isNaN(d) || (c.lineNumber = c.lineNumber + ":" + d);
            if (void 0 !== a.sampleWeight) a = a.sampleWeight;
            else a: {
                a = cj();d = u(a.i);
                for (e = d.next(); !e.done; e = d.next())
                    if (e = e.value, c.message && c.message.match(e.wk)) {
                        a = e.weight;
                        break a
                    }
                a = u(a.h);
            ...
            c.sampleWeight = a;
            a = u($i);
            for (d = a.next(); !d.done; d =
                a.next())
                if (d = d.value, d.qa[c.name])
                    for (f = u(d.qa[c.name]), e = f.next(); !e.done; e = f.next())
                        if (g = e.value, e = c.message.match(g.regexp)) {
                            c.params["params.error.original"] = e[0];
                            f = g.groups;
                            g = {};
                            for (h = 0; h < f.length; h++) g[f[h]] = e[h + 1], c.params["params.error." + f[h]] = e[h + 1];
                            c.message = d.ya(g);
                            break
                        }
            c.params || (c.params = {});
            a = cj();
            c.params["params.errorServiceSignature"] = "msg=" + a.i.length + "&cb=" + a.h.length;
            c.params["params.serviceWorker"] = "false";
            c.params["params.fscripts"] = String(document.querySelectorAll("script:not([nonce])").length);
            window.yterr && "function" === typeof window.yterr && window.yterr(c);
            a = 0 === c.sampleWeight;
            if (!ij.has(c.message) && !a) {
                "ERROR" === b ? (dj.O("handleError", c), O("record_app_crashed_web") && 0 === lj && 1 === c.sampleWeight && (lj++, V("appCrashed", {
                    appCrashType: "APP_CRASH_TYPE_BREAKPAD"
                })), kj++) : "WARNING" === b && dj.O("handleWarning", c);
                if (O("kevlar_gel_error_routing")) {
                    d = b;
                    a: {
                        a = u(mj);
                        for (e = a.next(); !e.done; e = a.next())
                            if (Wh(e.value.toLowerCase())) {
                                a = !0;
                                break a
                            }
                        a = !1
                    ...
                    if (!a) {
                        ...
                        c.fileName && (e.filename = c.fileName);
                        a = c.lineNumber && c.lineNumber.split ? c.lineNumber.split(":") : [];
                        0 !== a.length && (1 !== a.length || isNaN(Number(a[0])) ? 2 !== a.length || isNaN(Number(a[0])) || isNaN(Number(a[1])) || (e.lineNumber = Number(a[0]), e.columnNumber = Number(a[1])) : e.lineNumber = Number(a[0]));
                        a = {
                        ...
                        "ERROR" === d ? a.level = "ERROR_LEVEL_ERROR" : "WARNING" === d && (a.level = "ERROR_LEVEL_WARNNING");
                        d = {
                            isObfuscated: !0,
                            browserStackInfo: e
                        };
                        ...
                        N("FEXP_EXPERIMENTS") && (e.experimentIds = N("FEXP_EXPERIMENTS"));
                        if (f = c.params)
                            for (g = u(Object.keys(f)), h = g.next(); !h.done; h = g.next()) h = h.value, e.kvPairs.push({
                                key: "client." + h,
                                value: String(f[h])
                            });
                        f = N("SERVER_NAME", void 0);
                        g = N("SERVER_VERSION", void 0);
                        f && g && (e.kvPairs.push({
                            key: "server.name",
                            value: f
                        }), e.kvPairs.push({
                ...
                if (!O("suppress_error_204_logging")) {
                    ...
                    if (b.postParams) {
                        ...
                        d = u(Object.keys(a));
                        for (e = d.next(); !e.done; e = d.next()) e = e.value, b.postParams["client." + e] = a[e];
                        if (a = N("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS", void 0))
                            for (d = u(Object.keys(a)), e = d.next(); !e.done; e = d.next()) e = e.value, b.postParams[e] =
                                a[e];
                        a = N("SERVER_NAME", void 0);
                        d = N("SERVER_VERSION", void 0);
                        a && d && (b.postParams["server.name"] = a, b.postParams["server.version"] = d)
                    }
                    sh(N("ECATCHER_REPORT_HOST", "") + "/error_204", b)
                }
                ij.add(c.message);
                jj++
            }
    ...
    function qj(a) {
        a && (a.dataset ? a.dataset[rj("loaded")] = "true" : a.setAttribute("data-loaded", "true"))
    }

    function sj(a, b) {
        return a ? a.dataset ? a.dataset[rj(b)] : a.getAttribute("data-" + b) : null
    }
    var tj = {};

    function rj(a) {
        return tj[a] || (tj[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
            return c.toUpperCase()
        }))
    };
    var uj = /\.vflset|-vfl[a-zA-Z0-9_+=-]+/,
        vj = /-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;
        ...
        if (window.spf && spf.script) {
            ...
            if (a) {
                var d = a.indexOf("jsbin/"),
                    e = a.lastIndexOf(".js"),
                    f = d + 6; - 1 < d && -1 < e && e > f && (c = a.substring(f, e), c = c.replace(uj, ""), c = c.replace(vj, ""), c = c.replace("debug-", ""), c = c.replace("tracing-", ""))
            }
    ...
    function xj(a, b, c) {
        ...
        var d = yj(a),
            ...
            f = e && sj(e, "loaded"),
            g = e && !f;
        f ? b && b() : (b && (f = tg(d, b), b = "" + Na(b), zj[b] = f), g || (e = Aj(a, d, function() {
            sj(e, "loaded") || (qj(e), wg(d), P(Sa(xg, d), 0))
        }, c)))
    }

    function Aj(a, b, c, d) {
        d = void 0 === d ? null : d;
        var e = Jc(document, "SCRIPT");
        e.id = b;
        e.onload = function() {
            c && setTimeout(c, 0)
        };
    ...
    function Bj(a) {
        ...
        b && (xg(a), b.parentNode.removeChild(b))
    }
    ...
    function Fj() {
        if (!O("disable_ad_status_on_html5_clients") && (!O("condition_ad_status_fetch_on_consent_cookie_html5_clients") || od.get("CONSENT", "").startsWith("YES+")) && "1" != gb(Kf(), "args", "privembed")) {
            var a = function() {
                Ej = !0;
                "google_ad_status" in window ? M("DCLKSTAT", 1) : M("DCLKSTAT", 2)
            };
            try {
                wj("//static.doubleclick.net/instream/ad_status.js", a)
            } catch (b) {}
            Dj.push(gg(function() {
                if (!(Ej || "google_ad_status" in window)) {
                    try {
                        Cj("//static.doubleclick.net/instream/ad_status.js", a)
                    } catch (b) {}
                    Ej = !0;
                    M("DCLKSTAT", 3)
                }
    ...
    function Gj() {
        return parseInt(N("DCLKSTAT", 0), 10)
    };
    ...
    Hj.prototype.initialize = function(a, b, c, d, e, f) {
        var g = this;
        f = void 0 === f ? !1 : f;
        b ? (this.i = !0, wj(b, function() {
            g.i = !1;
            var h = 0 <= b.indexOf("/th/");
            (h ? window.trayride : window.botguard) ? Ij(g, c, d, f, h): (Bj(b), nj(new R("Unable to load Botguard", "from " + b)))
        }, e)) : a && (e = Jc(document, "SCRIPT"), e.textContent = a, e.nonce = Fa(), document.head.appendChild(e), document.head.removeChild(e), ((a = a.includes("trayride")) ? window.trayride : window.botguard) ? Ij(this, c, d, f, a) : nj(Error("Unable to load Botguard from JS")))
    };
    ...
    function Lj(a) {
        a = void 0 === a ? {} : a;
        a = void 0 === a ? {} : a;
        return Jj.h ? Jj.h.hot ? Jj.h.hot(void 0, void 0, a) : Jj.h.invoke(void 0, void 0, a) : null
    };
    var Mj = E().toString();
    ...
    function Nj() {
        a: {
            ...
            if (Mj)
                for (a = 1, b = 0; b < Mj.length; b++) d[a % 16] = d[a % 16] ^ d[(a - 1) % 16] / 4 ^ Mj.charCodeAt(b), a++
        }
        a = [];
        for (b = 0; b < d.length; b++) a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b] & 63));
        return a.join("")
    };
    var Oj = x.ytLoggingDocDocumentNonce_ || Nj();
    z("ytLoggingDocDocumentNonce_", Oj, void 0);
    var Pj = {
        Wd: 0,
        Yb: 1,
        ic: 2,
    ...
    Rj.prototype.getAsJson = function() {
        var a = {};
    ...
    Rj.prototype.isClientVe = function() {
    ...
    function Vj(a) {
        return N(Uj(void 0 === a ? 0 : a), void 0)
    }
    z("yt_logging_screen.getRootVeType", Vj, void 0);

    function Wj(a) {
        return (a = Vj(void 0 === a ? 0 : a)) ? new Rj({
            veType: a,
            youtubeData: void 0
        }) : null
    }
    ...
    z("yt_logging_screen.getCurrentCsn", W, void 0);
    ...
    z("yt_logging_screen.getCttAuthInfo", Zj, void 0);

    function ak(a, b, c, d) {
        c = void 0 === c ? 0 : c;
        if (a !== N(Tj(c)) || b !== N(Uj(c)))
            if (Yj(a, d, c), M(Tj(c), a), M(Uj(c), b), 0 == c || O("web_screen_associated_all_layers")) b = function() {
                setTimeout(function() {
                    a && Ug("foregroundHeartbeatScreenAssociated", {
                        clientDocumentNonce: Oj,
                        clientScreenNonce: a
                    }, Zi)
                }, 0)
            }, "requestAnimationFrame" in window ? window.requestAnimationFrame(b) : b()
    }
    z("yt_logging_screen.setCurrentScreen", ak, void 0);

    function bk(a) {
        Ih.call(this, 1, arguments);
        this.csn = a
    }
    v(bk, Ih);
    var Rh = new Jh("screen-created", bk),
        ck = [],
        ek = dk,
        fk = 0;
    ...
    function gk(a, b, c, d) {
        ...
        d = u(d);
        for (var e = d.next(); !e.done; e = d.next()) e = e.value.getAsJson(), (jb(e) || !e.trackingParams && !e.veType) && nj(Error("Child VE logged with no data"));
        d = {
            L: Zj(b),
            M: b
        };
        "UNDEFINED_CSN" == b ? hk("visualElementAttached", c, d) : a ? Ug("visualElementAttached", c, a, d) : V("visualElementAttached", c, d)
    }

    function ik(a, b) {
        var c = O("use_default_events_client") ? void 0 : Zi,
            d = {
                csn: a,
                ve: b.getAsJson(),
                eventType: 1
        ...
        "UNDEFINED_CSN" == a ? hk("visualElementShown", d, e) : c ? Ug("visualElementShown", d, c, e) : V("visualElementShown", d, e)
    }
    ...
    function jk(a, b, c) {
        ...
        "UNDEFINED_CSN" == b ? hk("visualElementGestured", c, d) : a ? Ug("visualElementGestured", c, a, d) : V("visualElementGestured", c, d)
    }
    ...
    function Th(a) {
        if (ck) {
            for (var b = u(ck), c = b.next(); !c.done; c = b.next()) c = c.value, c.payload && (c.payload.csn = a.csn, Ug(c.payloadName, c.payload, null, c.options));
            ck.length = 0
        }
        fk = 0
    };
    ...
    function kk(a, b, c) {
        gk(O("use_default_events_client") ? void 0 : Zi, a, b, [c])
    };
    var lk = {
        Vb: 29434,
        Xb: 3611,
    ...
    mk.prototype.A = function() {
        for (; this.h.length;) {
            var a = this.h.pop();
            a.target.removeEventListener(a.name, a.Fa)
        }
    ...
    var ok = /cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;
    ...
    function qk(a) {
        var b = rk(a),
            ...
            d = c && sj(c, "loaded");
        d || c && !d || (c = sk(a, b, function() {
            sj(c, "loaded") || (qj(c), wg(b), P(Sa(xg, b), 0))
        }))
    }
    ...
    function tk(a, b, c, d) {
        ...
        this.Z = this.H = null;
        this.J = new L;
        Tc(this, Sa(Rc, this.J));
        this.m = {};
        this.S = this.aa = this.l = this.ja = this.h = null;
        this.R = !1;
        this.o = this.F = null;
        this.ca = {};
        this.Ca = ["onReady"];
        ...
        this.j = d;
        uk(this);
        this.da("WATCH_LATER_VIDEO_ADDED", this.Ya.bind(this));
        this.da("WATCH_LATER_VIDEO_REMOVED", this.Za.bind(this));
        this.da("onAdAnnounce", this.Ea.bind(this));
        this.Da = new mk(this);
        Tc(this, Sa(Rc,
            this.Da));
        this.Y = 0;
    ...
    m.loadNewVideoConfig = function(a) {
        if (!this.i) {
            this.Y && (dg(this.Y), this.Y = 0);
            a instanceof nk || (a = new nk(a));
            this.ja = a;
            this.h = a.clone();
            vk(this);
            this.aa || (this.aa = xk(this, this.h.args.jsapicallback || "onYouTubePlayerReady"));
            this.h.args.jsapicallback = null;
            if (a = this.h.attrs.width) this.u.style.width = id(Number(a) || String(a));
            if (a = this.h.attrs.height) this.u.style.height = id(Number(a) || String(a));
            wk(this);
            this.B && yk(this)
        }
    };
    ...
    function vk(a) {
        ...
        a.l = b || a.l;
        "video-player" == a.l && (a.l = a.I, a.j ? a.j.rootElementId = a.I : a.h.attrs.id = a.I);
    ...
    function wk(a) {
        if (!a.i && !a.R) {
            var b = zk(a);
            if (b && "html5" == (Ak(a) ? "html5" : null)) a.S = "html5", a.B || Ck(a);
            else if (Dk(a), a.S = "html5", b && a.o) a.ba.appendChild(a.o), Ck(a);
            else {
                a.h && (a.h.loaded = !0);
                var c = !1;
                a.F = function() {
                    c = !0;
                    var d = Ek(a, "player_bootstrap_method") ? A("yt.player.Application.createAlternate") || A("yt.player.Application.create") : A("yt.player.Application.create");
                    var e = a.h ? a.h.clone() : void 0;
                    d(a.ba, e, a.j);
                    Ck(a)
                };
                a.R = !0;
                b ? a.F() : (wj(Bk(a), a.F), (b = a.j ? a.j.cssUrl : a.h.assets.css) && pk(b), Fk(a) && !c && z("yt.player.Application.create", null, void 0))
            }
        }
    }
    ...
    function Ck(a) {
        if (!a.i) {
            ...
            c ? (a.R = !1, !Ek(a, "html5_remove_not_servable_check_killswitch") && b.isNotServable && a.h && b.isNotServable(a.h.args.video_id) || Gk(a)) : a.ra = P(function() {
                Ck(a)
            }, 50)
        }
    }
    ...
    function Gk(a) {
        ...
        a.B = !0;
        var b = Ak(a);
        b.addEventListener && (a.H = Hk(a, b, "addEventListener"));
        b.removeEventListener && (a.Z = Hk(a, b, "removeEventListener"));
        var c = b.getApiInterface();
        c = c.concat(b.getInternalApiInterface());
        for (var d = 0; d < c.length; d++) {
            var e = c[d];
            a.api[e] || (a.api[e] = Hk(a, b, e))
        }
        for (var f in a.m) a.H(f, a.m[f]);
        yk(a);
        a.aa && a.aa(a.api);
        a.J.O("onReady", a.api)
    }
    ...
    function Hk(a, b, c) {
        ...
        return function() {
            try {
                return a.ia = null, d.apply(b, arguments)
            } catch (e) {
                "sendAbandonmentPing" != c && (e.params = c, a.ia = e, Pf(e))
            }
        }
    }
    ...
    function uk(a) {
        a.B = !1;
        if (a.Z)
            for (var b in a.m) a.Z(b, a.m[b]);
        for (var c in a.X) dg(parseInt(c, 10));
        a.X = {};
        a.H = null;
        a.Z = null;
        for (var d in a.api) a.api[d] = null;
        a.api.addEventListener = a.da.bind(a);
        a.api.removeEventListener = a.fb.bind(a);
        a.api.destroy = a.dispose.bind(a);
        a.api.getLastError = a.Ka.bind(a);
        a.api.getPlayerType = a.La.bind(a);
        a.api.getCurrentVideoConfig = a.Ja.bind(a);
        a.api.loadNewVideoConfig = a.loadNewVideoConfig.bind(a);
        a.api.isReady = a.Wa.bind(a)
    }
    m.Wa = function() {
        return this.B
    };
    m.da = function(a, b) {
        var c = this,
            d = xk(this, b);
        if (d) {
            if (!(0 <= Ya(this.Ca, a) || this.m[a])) {
                var e = Ik(this, a);
                this.H && this.H(a, e)
            }
            this.J.subscribe(a, d);
            "onReady" == a && this.B && P(function() {
                d(c.api)
            }, 0)
        }
    };
    ...
    m.Ya = function(a) {
        wg("WATCH_LATER_VIDEO_ADDED", a)
    };
    m.Za = function(a) {
        wg("WATCH_LATER_VIDEO_REMOVED", a)
    };
    m.La = function() {
        return this.S || (Ak(this) ? "html5" : null)
    };
    m.Ka = function() {
        return this.ia
    };
    ...
    function Dk(a) {
        ...
        a.h && (a.h.loaded = !1);
        var b = Ak(a);
        b && (zk(a) || !Fk(a) ? a.o = b : (b && b.destroy && b.destroy(), a.o = null));
        for (a = a.ba; b = a.firstChild;) a.removeChild(b)
    }
    m.cancel = function() {
        this.F && Cj(Bk(this), this.F);
        dg(this.ra);
        this.R = !1
    };
    m.A = function() {
        ...
        this.ca = null;
        for (var a in this.m) x[this.m[a]] = null;
        this.ja = this.h = this.api = null;
        delete this.ba;
        delete this.u;
        K.prototype.A.call(this)
    };
    ...
    var Jk = {},
        Kk = "player_uid_" + (1E9 * Math.random() >>> 0);

    function Lk(a, b, c) {
        var d = "player";
        c = void 0 === c ? !0 : c;
        d = "string" === typeof d ? Fc(d) : d;
        var e = Kk + "_" + Na(d),
            f = Jk[e];
        if (f && c) return Mk(a, b) ? f.api.loadVideoByPlayerVars(a.args || null) : f.loadNewVideoConfig(a), f.api;
        f = new tk(d, e, a, b);
        Jk[e] = f;
        wg("player-added", f.api);
        Tc(f, function() {
            delete Jk[f.getId()]
        });
        return f.api
    ...
    function Nk(a) {
        ...
        K.call(this);
        this.h = new L(a);
        Tc(this, Sa(Rc, this.h))
    }
    F(Nk, K);
    Nk.prototype.subscribe = function(a, b, c) {
        return this.i ? 0 : this.h.subscribe(a, b, c)
    };
    Nk.prototype.m = function(a, b) {
    ...
    function Pk(a, b, c) {
        if (!a.i) {
            ...
            d.i || a.l != d.h || (a = {
                id: a.o,
                command: b
            }, c && (a.data = c), d.h.postMessage(Se(a), d.l))
        }
    }
    Ok.prototype.A = function() {
        this.l = this.j = null;
        Nk.prototype.A.call(this)
    };

    function Qk(a) {
        K.call(this);
        this.h = a;
        this.h.subscribe("command", this.Aa, this);
        this.j = {};
        this.m = !1
    }
    v(Qk, K);
    m = Qk.prototype;
    m.start = function() {
        this.m || this.i || (this.m = !0, Pk(this.h, "RECEIVING"))
    };
    m.Aa = function(a, b, c) {
        if (this.m && !this.i) {
            var d = b || {};
            switch (a) {
                case "addEventListener":
                    "string" === typeof d.event && (a = d.event, a in this.j || (c = C(this.hb, this, a), this.j[a] = c, this.addEventListener(a, c)));
                    break;
                case "removeEventListener":
                    "string" === typeof d.event && Rk(this, d.event);
                    break;
                default:
                    this.l.isReady() && this.l.isExternalMethodAvailable(a, c || null) && (b = Sk(a, b || {}), c = this.l.handleExternalCall(a, b, c || null), (c = Tk(a, c)) && this.m && !this.i && Pk(this.h, a, c))
            }
        }
    };
    m.hb = function(a, b) {
        this.m && !this.i && Pk(this.h, a, this.la(a, b))
    };
    m.la = function(a, b) {
        if (null != b) return {
            value: b
    ...
    function Rk(a, b) {
        b in a.j && (a.removeEventListener(b, a.j[b]), delete a.j[b])
    }
    m.A = function() {
        var a = this.h;
        a.i || rf(a.h, "command", this.Aa, this);
        this.h = null;
        for (var b in this.j) Rk(this, b);
        K.prototype.A.call(this)
    };
    ...
    v(Yk, Qk);
    Yk.prototype.addEventListener = function(a, b) {
        this.l.addEventListener(a, b)
    };
    Yk.prototype.removeEventListener = function(a, b) {
    ...
    Yk.prototype.la = function(a, b) {
        ...
        return Qk.prototype.la.call(this, a, b)
    };
    Yk.prototype.A = function() {
        Qk.prototype.A.call(this);
        delete this.l
    };
    ...
    function Zk(a, b, c) {
        K.call(this);
        var d = this;
        c = c || N("POST_MESSAGE_ORIGIN", void 0) || window.document.location.protocol + "//" + window.document.location.hostname;
        this.j = b || null;
        this.B = "*";
        this.l = c;
        this.sessionId = null;
        ...
        this.u = function(e) {
            a: if (!("*" != d.l && e.origin != d.l || d.j && e.source != d.j || "string" !== typeof e.data)) {
                ...
                if (!(null == f || d.F && (d.sessionId && d.sessionId != f.id || d.channel && d.channel != f.channel)) && f) switch (f.event) {
                    case "listening":
                        "null" !=
    ...
    v(Zk, K);
    Zk.prototype.sendMessage = function(a, b) {
        var c = b || this.j;
        if (c) {
    ...
    function $k() {
        var a = this.i = new Zk(!!N("WIDGET_ID_ENFORCE")),
            b = C(this.eb, this);
        a.m = b;
        a.o = null;
        this.i.channel = "widget";
        if (a = N("WIDGET_ID")) this.i.sessionId = a;
        this.l = [];
        this.o = !1;
        this.m = {}
    }
    m = $k.prototype;
    m.eb = function(a, b, c) {
        "addEventListener" == a && b ? (a = b[0], this.m[a] || "onReady" == a || (this.addEventListener(a, al(this, a)), this.m[a] = !0)) : this.za(a, b, c)
    };
    m.za = function() {};
    ...
    m.Ia = function() {
        this.o = !0;
        this.sendMessage("initialDelivery", this.ma());
        this.sendMessage("onReady");
        G(this.l, this.Ba, this);
        this.l = []
    };
    m.ma = function() {
        return null
    ...
    m.Ba = function(a) {
        this.o ? this.i.sendMessage(a) : this.l.push(a)
    };
    ...
    function cl(a) {
        ...
        this.h = a;
        this.j = [];
        this.addEventListener("onReady", C(this.ab, this));
        this.addEventListener("onVideoProgress", C(this.lb, this));
        this.addEventListener("onVolumeChange", C(this.mb, this));
        this.addEventListener("onApiChange", C(this.gb, this));
        this.addEventListener("onPlaybackQualityChange", C(this.ib, this));
        this.addEventListener("onPlaybackRateChange", C(this.jb, this));
        this.addEventListener("onStateChange", C(this.kb, this));
        this.addEventListener("onWebglSettingsChanged", C(this.nb,
            this))
    }
    v(cl, $k);
    m = cl.prototype;
    m.za = function(a, b, c) {
        if (this.h.isExternalMethodAvailable(a, c)) {
            ...
            Uk(a) && bl(this, this.ma())
        }
    };
    m.ab = function() {
        var a = C(this.Ia, this);
        this.i.h = a
    };
    ...
    function dl(a, b, c) {
        ...
        this.h = a;
        this.l = c;
        this.m = ag(window, "message", C(this.o, this));
        this.j = new Ok(this, a, b);
        Tc(this, Sa(Rc, this.j))
    }
    v(dl, K);
    dl.prototype.o = function(a) {
        ...
        if (b && (b = a.data, "string" === typeof b)) {
            ...
            b.command && (c = this.j, c.i || c.m("command", b.command, b.data, a.origin))
        }
    };
    ...
    function el() {
        var a = mb(fl),
            b;
        return ff(new Ze(function(c, d) {
            a.onSuccess = function(e) {
                jh(e) ? c(e) : d(new gl("Request failed, status=" + (e && "status" in e ? e.status : -1), "net.badstatus", e))
            };
            a.onError = function(e) {
                d(new gl("Unknown request error", "net.unknown", e))
            };
            a.onTimeout = function(e) {
                d(new gl("Request timed out", "net.timeout", e))
            };
            b = sh("//googleads.g.doubleclick.net/pagead/id", a)
        }), function(c) {
            c instanceof gf && b.abort();
            return df(c)
        })
    }
    ...
    hl.prototype.then = function(a, b, c) {
        return 1 === this.i && a ? (a = a.call(c, this.h), Ye(a) ? a : il(a)) : 2 === this.i && b ? (a = b.call(c, this.h), Ye(a) ? a : jl(a)) : this
    };
    hl.prototype.getValue = function() {
        return this.h
    };
    hl.prototype.$goog_Thenable = !0;
    ...
    function kl(a) {
        ...
        this.isTimeout = a instanceof gl && "net.timeout" == a.errorCode;
        this.isCanceled = a instanceof gf
    }
    v(kl, Va);
    ...
    function Wg() {
        if (O("disable_biscotti_fetch_on_html5_clients")) return df(Error("Fetching biscotti ID is disabled."));
        if (O("condition_biscotti_fetch_on_consent_cookie_html5_clients") && !od.get("CONSENT", "").startsWith("YES+")) return df(Error("User has not consented - not fetching biscotti id."));
        if ("1" === gb(Kf(), "args", "privembed")) return df(Error("Biscotti ID is not available in private embed mode"));
        ml || (ml = ff(el().then(nl), function(a) {
            return ol(2, a)
        }));
        return ml
    }
    ...
    function rl(a) {
        if ("1" !== gb(Kf(), "args", "privembed")) {
            a && Vg();
            try {
                ql().then(function() {}, function() {}), P(rl, 18E5)
            } catch (b) {
                Of(b)
            }
        }
    };
    var X = A("ytglobal.prefsUserPrefsPrefs_") || {};
    z("ytglobal.prefsUserPrefsPrefs_", X, void 0);

    function sl() {
        this.h = N("ALT_PREF_COOKIE_NAME", "PREF");
        this.i = N("ALT_PREF_COOKIE_DOMAIN", "youtube.com");
        var a = od.get("" + this.h, void 0);
        if (a) {
            a = decodeURIComponent(a).split("&");
            for (var b = 0; b < a.length; b++) {
                var c = a[b].split("="),
                    d = c[0];
                (c = c[1]) && (X[d] = c.toString())
            }
        }
    }
    m = sl.prototype;
    m.get = function(a, b) {
        tl(a);
        ul(a);
        var c = void 0 !== X[a] ? X[a].toString() : null;
        return null != c ? c : b ? b : ""
    };
    m.set = function(a, b) {
        tl(a);
    ...
    m.save = function() {
        var a = this.h,
            b = [],
            c;
        for (c in X) b.push(c + "=" + encodeURIComponent(String(X[c])));
        Bh(a, b.join("&"), 63072E3, this.i)
    };
    m.clear = function() {
    ...
    function vl(a) {
        a = void 0 !== X[a] ? X[a].toString() : null;
    ...
    function xl(a, b) {
        for (var c = [], d = 1; d < arguments.length; ++d) c[d - 1] = arguments[d];
        if (!yl(a) || c.some(function(e) {
                return !yl(e)
            })) throw Error("Only objects may be merged.");
        c = u(c);
        for (d = c.next(); !d.done; d = c.next()) zl(a, d.value);
        return a
    }
    ...
    function zl(a, b) {
        for (var c in b)
            if (yl(b[c])) {
                if (c in a && !yl(a[c])) throw Error("Cannot merge an object into a non-object.");
                c in a || (a[c] = {});
                zl(a[c], b[c])
            } else if (Al(b[c])) {
            if (c in a && !Al(a[c])) throw Error("Cannot merge an array into a non-array.");
            c in a || (a[c] = []);
            Bl(a[c], b[c])
        } else a[c] = b[c];
        return a
    ...
    function Bl(a, b) {
        for (var c = u(b), d = c.next(); !d.done; d = c.next()) d = d.value, yl(d) ? a.push(zl({}, d)) : Al(d) ? a.push(Bl([], d)) : a.push(d);
        return a
    }
    ...
    function El(a, b, c, d, e) {
        ...
        if (a)
            if (c && !Wh("cobalt")) {
                if (a) {
                    a instanceof H || (a = "object" == typeof a && a.U ? a.T() : String(a), Jb.test(a) ? a = new H(a, Fb) : (a = String(a), a = a.replace(/(%0A|%0D)/g, ""), a = (b = a.match(Ib)) && Hb.test(b[1]) ? new H(a, Fb) : null));
                    a = Gb(a || Lb);
                    if ("about:invalid#zClosurez" === a || a.startsWith("data")) a = "";
                        ...
                        if (!(a instanceof Pb)) {
                            ...
                            var f = null;
                            b && a.na && (f = a.ka());
                            a = Rb(wb(b && a.U ? a.T() : String(a)), f)
                        }
                        a instanceof Pb && a.constructor === Pb ? a = a.h : (La(a), a = "type_error:SafeHtml");
                        a = encodeURIComponent(String(Se(a.toString())))
                    }
                    /^[\s\xa0]*$/.test(a) || (a = Ic("IFRAME", {
                        src: 'javascript:"<body><img src=\\""+' + a + '+"\\"></body>"',
                        style: "display:none"
                    }), (9 == a.nodeType ? a : a.ownerDocument || a.document).body.appendChild(a))
                }
            } else if (e) th(a, b, "POST", e, d);
        else if (N("USE_NET_AJAX_FOR_PING_TRANSPORT", !1) || d) th(a, b, "GET", "", d);
        else {
            b: {
                try {
                    var g = new Wa({
                    ...
                    if (g.j && g.i || g.l) {
                        ...
                        if (!(k = !h || !h.endsWith("/aclk"))) {
                            ...
                            if (0 > q) var r = null;
                                ...
                                if (0 > w || w > l) w = l;
                                q += 3;
                                r = decodeURIComponent(a.substr(q, w - q).replace(/\+/g, " "))
                            }
                            k = "1" !== r
                        }
                        f = !k;
            ...
            f ? Fl(a) ? (b && b(), f = !0) : f = !1 : f = !1;f || Gl(a, b)
        }
    }
    ...
    v(Il, Ih);
    var Jl = new Jh("aft-recorded", Hl),
        Kl = new Jh("timing-sent", Il);
    var Ll = window;
    ...
    var Ol = !1;
    C(Nl.clearResourceTimings || Nl.webkitClearResourceTimings || Nl.mozClearResourceTimings || Nl.msClearResourceTimings || Nl.oClearResourceTimings || Ja, Nl);

    function Pl(a) {
        var b = Ql(a);
        if (b.aft) return b.aft;
        a = N((a || "") + "TIMING_AFT_KEYS", ["ol"]);
    ...
    function Ul(a) {
        var b = Ql(a || ""),
            c = Pl(a);
        c && !Ol && (Oh(Jl, new Hl(Math.round(c - b._start), a)), Ol = !0)
    };
    ...
    var Xl = x.ytLoggingLatencyUsageStats_ || {};
    z("ytLoggingLatencyUsageStats_", Xl, void 0);
    ...
    Yl.prototype.tick = function(a, b, c) {
        $l(this, "tick_" + a + "_" + b) || V("latencyActionTicked", {
            tickName: a,
            clientActionNonce: b
        }, {
            timestamp: c
    ...
    Yl.prototype.info = function(a, b) {
        var c = Object.keys(a).join("");
        $l(this, "info_" + c + "_" + b) || (c = Object.assign({}, a), c.clientActionNonce = b, V("latencyActionInfo", c))
    };
    Yl.prototype.span = function(a, b) {
        var c = Object.keys(a).join("");
        $l(this, "span_" + c + "_" + b) || (a.clientActionNonce = b, V("latencyActionSpan", a))
    };
    ...
    function $l(a, b) {
        ...
        a.h || (a.h = hg(function() {
            var d = Q(),
                e;
            for (e in Xl) Xl[e] && 6E4 < d - Xl[e].time && delete Xl[e];
            a && (a.h = 0)
        }, 0, 5E3));
    ...
    var Y = {},
        ...
        bm = "isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),
        cm = {},
        dm = (cm.ccs = "CANARY_STATE_", cm.mver = "MEASUREMENT_VERSION_",
            cm.pis = "PLAYER_INITIALIZED_STATE_", cm.yt_pt = "LATENCY_PLAYER_", cm.pa = "LATENCY_ACTION_", cm.yt_vst = "VIDEO_STREAM_TYPE_", cm),
        em = "all_vc ap aq c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");

    function fm(a) {
        return !!N("FORCE_CSI_ON_GEL", !1) || O("csi_on_gel") || !!Rl(a).useGel
    }
        ...
        if (null !== b)
            if (Sl(c)[a] = b, fm(c)) {
                ...
                if (a in am) {
                    b = am[a];
                    0 <= Ya(bm, b) && (d = !!d);
                    a in dm && "string" === typeof d && (d = dm[a] + d.toUpperCase());
                    a = d;
                    d = b.split(".");
                    ...
                    f = xl({}, e)
                } else 0 <= Ya(em, a) || nj(new R("Unknown label logged with GEL CSI",
                    a)), f = void 0;
                f && fm(c) && (b = Wl(c || ""), xl(b.info, f), b = gm(c), b.gelInfos || (b.gelInfos = {}), xl(b.gelInfos, f), c = Tl(c), Zl().info(f, c))
            } else Wl(c || "").info[a] = b
    }

    function im(a, b, c) {
        var d = Ql(c);
        if (O("use_first_tick") && jm(a, c)) return d[a];
        if (!b && "_" !== a[0]) {
            var e = a;
            Nl.mark && (0 == e.lastIndexOf("mark_", 0) || (e = "mark_" + e), c && (e += " (" + c + ")"), Nl.mark(e))
        }
        e = b || Q();
        d[a] = e;
        e = gm(c);
        ...
        if (fm(c)) {
            ...
            if ("_start" === a) {
                var f = Zl();
                $l(f, "baseline_" + e) || V("latencyActionBaselined", {
                    clientActionNonce: e
                }, {
                    timestamp: b
                })
        ...
        if (!e) {
            if (!A("yt.timing." + (c || "") + "pingSent_") &&
                (f = N((c || "") + "TIMING_ACTION", void 0), e = Ql(c), A("ytglobal.timing" + (c || "") + "ready_") && f && jm("_start") && Pl(c)))
                if (Ul(c), c) km(c);
                else {
                    f = !0;
                    var g = N("TIMING_WAIT", []);
    ...
    function km(a) {
        if (!fm(a)) {
            var b = Ql(a),
                c = Sl(a),
                d = b._start,
                e = N("CSI_SERVICE_NAME", "youtube"),
                f = {
                    v: 2,
                    s: e,
                    action: N((a || "") + "TIMING_ACTION", void 0)
                },
                g = c.srt;
            ...
            var h = Ql(a),
                ...
                l = h.vc;
            h = h.pbs;
            k && l && h && k < l && l < h && Sl(a).yt_pvis && "youtube" === e && (hm("yt_lt", "hot_bg", a), e = b.vc, k = b.pbs, delete b.aft, c.aft = Math.round(k - e));
            ...
            f.rt =
                e.join(",");
            b = !!c.ap;
            O("debug_csi_data") && (c = A("yt.timing.csiData"), c || (c = [], Ta("yt.timing.csiData", c)), c.push({
                page: location.href,
                time: new Date,
                args: f
            }));
            ...
            if (window.navigator && window.navigator.sendBeacon && (b || O("always_send_csi_204_with_beacon"))) {
                var r = void 0 === r ? "" : r;
                Fl(f, r) || El(f, void 0, void 0, void 0, r)
            } else El(f);
            z("yt.timing." + (a || "") + "pingSent_", !0, void 0);
            Oh(Kl, new Il(n.aft + (Number(g) || 0), a))
        }
    }
    var lm = window;
    lm.ytcsi && (lm.ytcsi.info = hm, lm.ytcsi.tick = im);
    ...
    function nm(a, b, c) {
        ...
        b.then(function(d) {
            ...
            var g = W(c),
                h = Wj(c);
            g && h && (d.csn = g, (null === (e = d.response) || void 0 === e ? 0 : e.trackingParams) && gk(a.client, g, h, [Sj(d.response.trackingParams)]), (null === (f = d.playerResponse) || void 0 === f ? 0 : f.trackingParams) && gk(a.client, g, h, [Sj(d.playerResponse.trackingParams)]))
        })
    }
    ...
    function om(a, b, c, d) {
        ...
        if (a.i.has(d)) a.l.push([b, c]);
            ...
            var e = W(d);
            c = c || Wj(d);
            e && c && gk(a.client, e, c, [b])
        }
    }
    mm.prototype.clickCommand = function(a) {
        var b = W();
        if (!a.clickTrackingParams || !b) return !1;
        jk(this.client, b, Sj(a.clickTrackingParams));
        return !0
    };
    ...
    function pm(a, b, c) {
        ...
        a.j = function() {
            ...
            var f = Wj(c.layer);
            if (f) {
                for (var g = u(a.l), h = g.next(); !h.done; h = g.next()) h = h.value, om(a, h[0], h[1] || f, c.layer);
                f = u(a.m);
                for (g = f.next(); !g.done; g = f.next()) {
                    ...
                    h && l && (g = a.client, k = k[1], k = {
                        ...
                        L: Zj(h),
                        M: h
                    }, "UNDEFINED_CSN" == h ? hk("visualElementStateChanged", k, l) : g ? Ug("visualElementStateChanged", k, g, l) : V("visualElementStateChanged",
                        k, l))
                }
            }
        };
        W(c.layer) || a.j();
        if (c.va)
            for (var d = u(c.va), e = d.next(); !e.done; e = d.next()) nm(a, e.value, c.layer);
        else oj(Error("Delayed screen needs a data promise."))
    }

    function qm(a, b, c) {
        c = void 0 === c ? {} : c;
        c.layer || (c.layer = 0);
        var d = void 0 !== c.bb ? c.bb : c.layer;
        var e = W(d);
        d = Wj(d);
        var f;
        ...
        try {
            ...
            } : h && nj(new R("newScreen() parent element does not have a VE - rootVe",
                b));
            k && (p.cloneCsn = k);
            k = {
                L: l,
            ...
            g ? Ug("screenCreated", p, g, k) : V("screenCreated", p, k);
            Oh(Rh, new bk(n));
            var q = n
        } catch (r) {
            pj(r, {
        ...
        b && (b = a.client, f = !0, g = (f = void 0 === f ? !1 : f) ? 16 : 8, d = {
            ...
            M: e,
            Ha: f
        }, "UNDEFINED_CSN" == e ? hk("visualElementHidden", d, f) : b ? Ug("visualElementHidden", d, b, f) : V("visualElementHidden", d, f));
        a.h[a.h.length - 1] && !a.h[a.h.length - 1].csn && (a.h[a.h.length - 1].csn = q || "");
        hm("csn", q);
        wl.getInstance().clear();
        d = Wj(c.layer);
        e && "UNDEFINED_CSN" !== e && d && (O("web_mark_root_visible") || O("music_web_mark_root_visible")) && ik(q, d);
        a.i["delete"](c.layer || 0);
        a.j = void 0;
        e = u(a.o);
        for (q = e.next(); !q.done; q = e.next()) q = u(q.value), b = q.next().value, q.next().value === c.layer && d && om(a, b, d, c.layer)
    };
    var Z = null,
        rm = null,
        sm = null,
    ...
    function xm(a) {
        tm[a.id] = Sj(a.tracking_params)
    }

    function ym(a) {
        var b = W();
        a = tm[a.id];
        b && a && jk(O("use_default_events_client") ? void 0 : Zi, b, a)
    }
    ...
    function Am(a, b, c) {
        ...
        if (b) {
            d = a;
            var e = void 0 === e ? !0 : e;
            var f = N("VALID_SESSION_TEMPDATA_DOMAINS", []),
                g = Yb(window.location.href);
            g && f.push(g);
            g = Yb(d);
            if (0 <= Ya(f, g) || !g && 0 == d.lastIndexOf("/", 0))
                if (O("autoescape_tempdata_url") && (f = document.createElement("a"), Sb(f, d), d = f.href), d) {
                    g = d.match(Wb);
                    d = g[5];
                    f = g[6];
                    g = g[7];
                    ...
                    if (d = 0 > f ? d : d.substr(0, f))
                        if (e && !b.csn && (b.itct || b.ved) &&
                            ...
                            var k = parseInt(k, 10);
                            isFinite(k) && 0 < k && (e = b, b = "ST-" + Vb(d).toString(36), e = e ? $b(e) : "", Bh(b, e, k || 5))
                        } else k = b, e = "ST-" + Vb(d).toString(36), k = k ? $b(k) : "", Bh(e, k, 5)
                }
        }
        if (c) return !1;
        if ((window.ytspf || {}).enabled) spf.navigate(a);
            ...
            c = p.location;
            a = ac(a, l) + n;
            a = a instanceof H ? a : Kb(a);
            c.href = Gb(a)
        }
        return !0
    };
    z("yt.setConfig", M, void 0);
    z("yt.config.set", M, void 0);
    z("yt.setMsg", Rf, void 0);
    z("yt.msgs.set", Rf, void 0);
    z("yt.logging.errors.log", oj, void 0);
    z("writeEmbed", function() {
        var a = N("PLAYER_CONFIG", void 0);
        if (!a) {
            var b = N("PLAYER_VARS", void 0);
            b && (a = {
                args: b
            })
        }
        ...
        b = N("POST_MESSAGE_ORIGIN");
        window !== window.top && c && c !== document.URL && (a.args.loaderUrl = c);
        if ((c = N("WEB_PLAYER_CONTEXT_CONFIGS", void 0)) && "WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER" in c) {
            var d = c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER;
            if (!d.serializedForcedExperimentIds) {
                var e = window.location.href; - 1 != e.indexOf("?") ? (e = (e || "").split("#")[0], e = e.split("?", 2), e = dh(1 < e.length ? e[1] : e[0])) : e = {};
                e.forced_experiments && (d.serializedForcedExperimentIds = e.forced_experiments)
            }
            Z = Lk(a, c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER, !1)
        } else Z = Lk(a);
        Z.addEventListener("onScreenChanged", wm);
        Z.addEventListener("onLogClientVeCreated", um);
        Z.addEventListener("onLogServerVeCreated", xm);
        Z.addEventListener("onLogVeClicked", ym);
        Z.addEventListener("onLogVesShown",
            zm);
        Z.addEventListener("onVideoDataChange", vm);
        a = N("POST_MESSAGE_ID", "player");
        N("ENABLE_JS_API") ? sm = new cl(Z) : N("ENABLE_POST_API") && "string" === typeof a && "string" === typeof b && (rm = new dl(window.parent, a, b), sm = new Yk(Z, rm.j));
        Fj()
    }, void 0);
    var Bm = Nf(function() {
            im("ol");
            var a = sl.getInstance(),
                b = !!((vl("f" + (Math.floor(119 / 31) + 1)) || 0) & 67108864),
                c = 1 < window.devicePixelRatio;
            if (document.body && Qd(document.body, "exp-invert-logo"))
                if (c && !Qd(document.body, "inverted-hdpi")) {
                    var d = document.body;
                    if (d.classList) d.classList.add("inverted-hdpi");
                    else if (!Qd(d, "inverted-hdpi")) {
                        var e = Od(d);
                        Pd(d, e + (0 < e.length ? " inverted-hdpi" : "inverted-hdpi"))
                    }
                } else !c && Qd(document.body, "inverted-hdpi") && Rd();
            b != c && (b = "f" + (Math.floor(119 / 31) + 1), d = vl(b) || 0, d = c ? d | 67108864 :
                d & -67108865, 0 == d ? delete X[b] : (c = d.toString(16), X[b] = c.toString()), a.save());
            mm.h || (mm.h = new mm);
            a = mm.h;
            c = 16623;
            var f = void 0 === f ? {} : f;
            Object.values(lk).includes(c) || (nj(new R("createClientScreen() called with a non-page VE", c)), c = 83769);
            ...
            a.l = [];
            a.m = [];
            f.va ? pm(a, c, f) : qm(a, c, f)
        }),
        Cm = Nf(function() {
            Z && Z.sendAbandonmentPing && Z.sendAbandonmentPing();
            N("PL_ATT") && Jj.dispose();
            for (var a = 0, b = Dj.length; a < b; a++) jg(Dj[a]);
            Dj.length = 0;
            Bj("//static.doubleclick.net/instream/ad_status.js");
            Ej = !1;
            M("DCLKSTAT", 0);
            Sc(sm, rm);
            Z && (Z.removeEventListener("onScreenChanged", wm), Z.removeEventListener("onLogClientVeCreated", um), Z.removeEventListener("onLogServerVeCreated", xm), Z.removeEventListener("onLogVeClicked", ym), Z.removeEventListener("onLogVesShown", zm), Z.removeEventListener("onVideoDataChange", vm), Z.destroy());
            tm = {}
        });
    window.addEventListener ? (window.addEventListener("load", Bm), window.addEventListener("unload", Cm)) : window.attachEvent && (window.attachEvent("onload", Bm), window.attachEvent("onunload", Cm));
    Ta("yt.abuse.player.botguardInitialized", A("yt.abuse.player.botguardInitialized") || Kj);
    Ta("yt.abuse.player.invokeBotguard", A("yt.abuse.player.invokeBotguard") || Lj);
    Ta("yt.abuse.dclkstatus.checkDclkStatus", A("yt.abuse.dclkstatus.checkDclkStatus") || Gj);
    Ta("yt.player.exports.navigate", A("yt.player.exports.navigate") || Am);
    Ta("yt.util.activity.init", A("yt.util.activity.init") || lg);
    Ta("yt.util.activity.getTimeSinceActive", A("yt.util.activity.getTimeSinceActive") || og);
    Ta("yt.util.activity.setTimestamp", A("yt.util.activity.setTimestamp") || mg);
}).call(this);